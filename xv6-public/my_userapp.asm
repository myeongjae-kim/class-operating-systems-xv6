...
int main(int argc, char *argv[])
{
   ...
   9:	c7 04 24 36 07 00 00 	movl   $0x736,(%esp)
  10:	e8 ed 02 00 00       	call   302 <my_syscall>
    printf(1, "Return value : 0x%x\n", ret_val);
  15:	c7 44 24 04 41 07 00 	movl   $0x741,0x4(%esp)
  1c:	00 
  1d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  24:	89 44 24 08          	mov    %eax,0x8(%esp)
  28:	e8 a3 03 00 00       	call   3d0 <printf>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 369:	0f b6 92 5d 07 00 00 	movzbl 0x75d(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4ff:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 501:	b8 56 07 00 00       	mov    $0x756,%eax
...
free(void *ap)
{
 ...
 62f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 632:	a3 d4 09 00 00       	mov    %eax,0x9d4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 1d d4 09 00 00    	mov    0x9d4,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 699:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 69b:	3b 15 d4 09 00 00    	cmp    0x9d4,%edx
...
morecore(uint nu)
{
 ...
 6cd:	e8 ee fe ff ff       	call   5c0 <free>
  return freep;
 6d2:	8b 15 d4 09 00 00    	mov    0x9d4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6f4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 6f7:	89 15 d4 09 00 00    	mov    %edx,0x9d4
      return (void*)(p + 1);
 ...
 70c:	eb e9                	jmp    6f7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 70e:	c7 05 d4 09 00 00 d8 	movl   $0x9d8,0x9d4
 715:	09 00 00 
    base.s.size = 0;
 718:	ba d8 09 00 00       	mov    $0x9d8,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 71d:	c7 05 d8 09 00 00 d8 	movl   $0x9d8,0x9d8
 724:	09 00 00 
    base.s.size = 0;
 727:	c7 05 dc 09 00 00 00 	movl   $0x0,0x9dc
 72e:	00 00 00 
