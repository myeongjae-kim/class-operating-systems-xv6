...
int main(int argc, char *argv[])
{
   ...
   9:	c7 04 24 26 07 00 00 	movl   $0x726,(%esp)
  10:	e8 ed 02 00 00       	call   302 <my_syscall>
    printf(1, "Return value : 0x%x\n", ret_val);
  15:	c7 44 24 04 31 07 00 	movl   $0x731,0x4(%esp)
  1c:	00 
  1d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  24:	89 44 24 08          	mov    %eax,0x8(%esp)
  28:	e8 93 03 00 00       	call   3c0 <printf>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 359:	0f b6 92 4d 07 00 00 	movzbl 0x74d(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4ef:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 4f1:	b8 46 07 00 00       	mov    $0x746,%eax
...
free(void *ap)
{
 ...
 61f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 622:	a3 c4 09 00 00       	mov    %eax,0x9c4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 1d c4 09 00 00    	mov    0x9c4,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 689:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 68b:	3b 15 c4 09 00 00    	cmp    0x9c4,%edx
...
morecore(uint nu)
{
 ...
 6bd:	e8 ee fe ff ff       	call   5b0 <free>
  return freep;
 6c2:	8b 15 c4 09 00 00    	mov    0x9c4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6e4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 6e7:	89 15 c4 09 00 00    	mov    %edx,0x9c4
      return (void*)(p + 1);
 ...
 6fc:	eb e9                	jmp    6e7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6fe:	c7 05 c4 09 00 00 c8 	movl   $0x9c8,0x9c4
 705:	09 00 00 
    base.s.size = 0;
 708:	ba c8 09 00 00       	mov    $0x9c8,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 70d:	c7 05 c8 09 00 00 c8 	movl   $0x9c8,0x9c8
 714:	09 00 00 
    base.s.size = 0;
 717:	c7 05 cc 09 00 00 00 	movl   $0x0,0x9cc
 71e:	00 00 00 
