...
main(int argc, char *argv[])
{
   ...
   c:	83 ec 10             	sub    $0x10,%esp
    uint pid, i, j, count = 100;
    pid = fork();
   f:	e8 86 02 00 00       	call   29a <fork>
  ...
  18:	e8 3d 03 00 00       	call   35a <getlev>
  1d:	c7 44 24 04 8c 07 00 	movl   $0x78c,0x4(%esp)
  24:	00 
  ...
  40:	e8 15 03 00 00       	call   35a <getlev>
  45:	c7 44 24 04 76 07 00 	movl   $0x776,0x4(%esp)
  4c:	00 
  ...
  60:	75 de                	jne    40 <main+0x40>
        ...
        printf(1, "\n");
  62:	c7 44 24 04 8a 07 00 	movl   $0x78a,0x4(%esp)
  69:	00 
  ...
  71:	e8 9a 03 00 00       	call   410 <printf>
    ...
    wait();
  76:	e8 2f 02 00 00       	call   2aa <wait>
...
free(void *ap)
{
 ...
 601:	a1 20 0a 00 00       	mov    0xa20,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 647:	89 10                	mov    %edx,(%eax)
  freep = p;
 649:	a3 20 0a 00 00       	mov    %eax,0xa20
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
 ...
 66f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 672:	a3 20 0a 00 00       	mov    %eax,0xa20
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 1d 20 0a 00 00    	mov    0xa20,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6d9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6db:	3b 15 20 0a 00 00    	cmp    0xa20,%edx
...
morecore(uint nu)
{
 ...
 70d:	e8 ee fe ff ff       	call   600 <free>
  return freep;
 712:	8b 15 20 0a 00 00    	mov    0xa20,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 734:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 737:	89 15 20 0a 00 00    	mov    %edx,0xa20
      return (void*)(p + 1);
 ...
 74c:	eb e9                	jmp    737 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 74e:	c7 05 20 0a 00 00 24 	movl   $0xa24,0xa20
 755:	0a 00 00 
    base.s.size = 0;
 758:	ba 24 0a 00 00       	mov    $0xa24,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 75d:	c7 05 24 0a 00 00 24 	movl   $0xa24,0xa24
 764:	0a 00 00 
    base.s.size = 0;
 767:	c7 05 28 0a 00 00 00 	movl   $0x0,0xa28
 76e:	00 00 00 
