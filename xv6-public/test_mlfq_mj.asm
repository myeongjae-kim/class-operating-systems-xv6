...
main(int argc, char *argv[])
{
  ...
  1d:	c7 44 24 04 ac 07 00 	movl   $0x7ac,0x4(%esp)
  24:	00 
  25:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  2c:	89 44 24 08          	mov    %eax,0x8(%esp)
  30:	e8 fb 03 00 00       	call   430 <printf>
            }
        }
        printf(1, "\n");
    } else if (pid > 0) {
  ...
  45:	c7 44 24 04 96 07 00 	movl   $0x796,0x4(%esp)
  4c:	00 
  ...
  60:	75 de                	jne    40 <main+0x40>
        ...
        printf(1, "\n");
  62:	c7 44 24 04 aa 07 00 	movl   $0x7aa,0x4(%esp)
  69:	00 
...
free(void *ap)
{
 ...
 68f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 692:	a3 40 0a 00 00       	mov    %eax,0xa40
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 1d 40 0a 00 00    	mov    0xa40,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6f9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6fb:	3b 15 40 0a 00 00    	cmp    0xa40,%edx
...
morecore(uint nu)
{
 ...
 72d:	e8 ee fe ff ff       	call   620 <free>
  return freep;
 732:	8b 15 40 0a 00 00    	mov    0xa40,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 754:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 757:	89 15 40 0a 00 00    	mov    %edx,0xa40
      return (void*)(p + 1);
 ...
 76c:	eb e9                	jmp    757 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 76e:	c7 05 40 0a 00 00 44 	movl   $0xa44,0xa40
 775:	0a 00 00 
    base.s.size = 0;
 778:	ba 44 0a 00 00       	mov    $0xa44,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 77d:	c7 05 44 0a 00 00 44 	movl   $0xa44,0xa44
 784:	0a 00 00 
    base.s.size = 0;
 787:	c7 05 48 0a 00 00 00 	movl   $0x0,0xa48
 78e:	00 00 00 
