...
80100bad:	e8 5e 5f 00 00       	call   80106b10 <clearpteu>
  sp = sz;
...
80100c19:	e8 52 60 00 00       	call   80106c70 <copyout>
...
80100c86:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c8c:	e8 df 5f 00 00       	call   80106c70 <copyout>
...
80100d11:	e8 5a 5a 00 00       	call   80106770 <switchuvm>
  freevm(oldpgdir);
80100d16:	89 34 24             	mov    %esi,(%esp)
80100d19:	e8 72 5d 00 00       	call   80106a90 <freevm>
  return 0;
...
80101ecc:	e8 8f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101ed1:	c7 04 24 c6 74 10 80 	movl   $0x801074c6,(%esp)
...
80103c6d:	e8 4e fe ff ff       	call   80103ac0 <sched>
  panic("zombie exit");
80103c72:	c7 04 24 65 73 10 80 	movl   $0x80107365,(%esp)
80103c79:	e8 e2 c6 ff ff       	call   80100360 <panic>
{
  ...
  if(proc == initproc)
    panic("init exiting");
80103c7e:	c7 04 24 58 73 10 80 	movl   $0x80107358,(%esp)
...
80103d6b:	c7 04 24 77 73 10 80 	movl   $0x80107377,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  if(proc == 0)
    panic("sleep");
80103d77:	c7 04 24 71 73 10 80 	movl   $0x80107371,(%esp)
...
80103f64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f68:	c7 04 24 c6 72 10 80 	movl   $0x801072c6,(%esp)
...
80103f8a:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103f8d:	ba 88 73 10 80       	mov    $0x80107388,%edx
  uint pc[10];
...
80103f94:	8b 14 85 c0 73 10 80 	mov    -0x7fef8c40(,%eax,4),%edx
      ...
      state = "???";
80103f9b:	b8 88 73 10 80       	mov    $0x80107388,%eax
...
80103fb0:	c7 04 24 8c 73 10 80 	movl   $0x8010738c,(%esp)
...
80103ff9:	c7 04 24 e9 6d 10 80 	movl   $0x80106de9,(%esp)
...
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
8010422a:	c7 04 24 e3 73 10 80 	movl   $0x801073e3,(%esp)
...
popcli(void)
{
  ...
  if(--cpu->ncli < 0)
    panic("popcli");
801042c5:	c7 04 24 02 74 10 80 	movl   $0x80107402,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
801042d1:	c7 04 24 eb 73 10 80 	movl   $0x801073eb,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
801042fb:	c7 04 24 09 74 10 80 	movl   $0x80107409,(%esp)
...
8010472c:	8b 0c 85 40 74 10 80 	mov    -0x7fef8bc0(,%eax,4),%ecx
...
80104756:	c7 04 24 11 74 10 80 	movl   $0x80107411,(%esp)
...
801048a0:	c7 44 24 04 bc 74 10 	movl   $0x801074bc,0x4(%esp)
801048a7:	80 
...
801048bb:	c7 44 24 04 bb 74 10 	movl   $0x801074bb,0x4(%esp)
801048c2:	80 
...
801048d1:	79 89                	jns    8010485c <create+0xdc>
      panic("create dots");
801048d3:	c7 04 24 af 74 10 80 	movl   $0x801074af,(%esp)
801048da:	e8 81 ba ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
801048df:	c7 04 24 be 74 10 80 	movl   $0x801074be,(%esp)
801048e6:	e8 75 ba ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
801048eb:	c7 04 24 a0 74 10 80 	movl   $0x801074a0,(%esp)
...
80104ca1:	c7 44 24 04 bc 74 10 	movl   $0x801074bc,0x4(%esp)
80104ca8:	80 
...
80104cb9:	c7 44 24 04 bb 74 10 	movl   $0x801074bb,0x4(%esp)
80104cc0:	80 
...
80104e08:	e9 48 ff ff ff       	jmp    80104d55 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104e0d:	c7 04 24 e0 74 10 80 	movl   $0x801074e0,(%esp)
80104e14:	e8 47 b5 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104e19:	c7 04 24 f2 74 10 80 	movl   $0x801074f2,(%esp)
80104e20:	e8 3b b5 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104e25:	c7 04 24 ce 74 10 80 	movl   $0x801074ce,(%esp)
...
80105519:	c7 44 24 04 01 75 10 	movl   $0x80107501,0x4(%esp)
80105520:	80 
...
801055b0:	ff 24 85 a8 75 10 80 	jmp    *-0x7fef8a58(,%eax,4)
801055b7:	90                   	nop
...
8010565f:	c7 04 24 64 75 10 80 	movl   $0x80107564,(%esp)
...
80105734:	c7 04 24 0c 75 10 80 	movl   $0x8010750c,(%esp)
...
801057e2:	c7 04 24 30 75 10 80 	movl   $0x80107530,(%esp)
801057e9:	89 44 24 04          	mov    %eax,0x4(%esp)
801057ed:	e8 5e ae ff ff       	call   80100650 <cprintf>
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
801057f2:	c7 04 24 06 75 10 80 	movl   $0x80107506,(%esp)
...
801058e0:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  ...
  for(p="xv6...\n"; *p; p++)
801058e7:	bb 28 76 10 80       	mov    $0x80107628,%ebx
...
801064c1:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
801064c2:	c7 04 24 30 76 10 80 	movl   $0x80107630,(%esp)
...
8010655a:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
8010655b:	c7 04 24 f2 6f 10 80 	movl   $0x80106ff2,(%esp)
...
80106777:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(p == 0)
8010677a:	85 db                	test   %ebx,%ebx
8010677c:	0f 84 94 00 00 00    	je     80106816 <switchuvm+0xa6>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80106782:	8b 43 08             	mov    0x8(%ebx),%eax
80106785:	85 c0                	test   %eax,%eax
80106787:	0f 84 a1 00 00 00    	je     8010682e <switchuvm+0xbe>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
8010678d:	8b 43 04             	mov    0x4(%ebx),%eax
80106790:	85 c0                	test   %eax,%eax
80106792:	0f 84 8a 00 00 00    	je     80106822 <switchuvm+0xb2>
    panic("switchuvm: no pgdir");

  pushcli();
80106798:	e8 c3 da ff ff       	call   80104260 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
8010679d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801067a3:	b9 67 00 00 00       	mov    $0x67,%ecx
801067a8:	8d 50 08             	lea    0x8(%eax),%edx
801067ab:	66 89 88 a0 00 00 00 	mov    %cx,0xa0(%eax)
801067b2:	89 d1                	mov    %edx,%ecx
801067b4:	66 89 90 a2 00 00 00 	mov    %dx,0xa2(%eax)
801067bb:	c1 ea 18             	shr    $0x18,%edx
801067be:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
801067c4:	c1 e9 10             	shr    $0x10,%ecx
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
801067c7:	ba 10 00 00 00       	mov    $0x10,%edx
801067cc:	66 89 50 10          	mov    %dx,0x10(%eax)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
  ...
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801067d0:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
801067d6:	c6 80 a6 00 00 00 40 	movb   $0x40,0xa6(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801067dd:	c6 80 a5 00 00 00 89 	movb   $0x89,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
801067e4:	8b 4b 08             	mov    0x8(%ebx),%ecx
801067e7:	8d 91 00 10 00 00    	lea    0x1000(%ecx),%edx
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
801067ed:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  ...
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
801067f2:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
801067f5:	66 89 48 6e          	mov    %cx,0x6e(%eax)
}
...
801067f9:	b8 30 00 00 00       	mov    $0x30,%eax
801067fe:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106801:	8b 43 04             	mov    0x4(%ebx),%eax
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106809:	0f 22 d8             	mov    %eax,%cr3
  popcli();
}
8010680c:	83 c4 14             	add    $0x14,%esp
8010680f:	5b                   	pop    %ebx
80106810:	5d                   	pop    %ebp
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106811:	e9 7a da ff ff       	jmp    80104290 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80106816:	c7 04 24 36 76 10 80 	movl   $0x80107636,(%esp)
8010681d:	e8 3e 9b ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
80106822:	c7 04 24 61 76 10 80 	movl   $0x80107661,(%esp)
...
80106896:	00 
80106897:	e8 b4 fb ff ff       	call   80106450 <mappages>
  memmove(mem, init, sz);
...
inituvm(pde_t *pgdir, char *init, uint sz)
{
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
801068b1:	c7 04 24 75 76 10 80 	movl   $0x80107675,(%esp)
...
80106903:	e8 b8 fa ff ff       	call   801063c0 <walkpgdir>
...
80106961:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106962:	c7 04 24 8f 76 10 80 	movl   $0x8010768f,(%esp)
80106969:	e8 f2 99 ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
8010696e:	c7 04 24 30 77 10 80 	movl   $0x80107730,(%esp)
...
801069e2:	00 
801069e3:	e8 68 fa ff ff       	call   80106450 <mappages>
...
801069ff:	75 af                	jne    801069b0 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106a01:	c7 04 24 ad 76 10 80 	movl   $0x801076ad,(%esp)
...
80106a2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106a30:	c7 04 24 c5 76 10 80 	movl   $0x801076c5,(%esp)
...
80106a49:	e8 82 fa ff ff       	call   801064d0 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106a62:	e8 69 fa ff ff       	call   801064d0 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106a80:	5d                   	pop    %ebp
80106a81:	e9 4a fa ff ff       	jmp    801064d0 <deallocuvm.part.0>
...
80106aaa:	e8 21 fa ff ff       	call   801064d0 <deallocuvm.part.0>
...
freevm(pde_t *pgdir)
{
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106af8:	c7 04 24 e1 76 10 80 	movl   $0x801076e1,(%esp)
...
80106b1e:	e8 9d f8 ff ff       	call   801063c0 <walkpgdir>
  if(pte == 0)
...
80106b2b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106b2c:	c7 04 24 f2 76 10 80 	movl   $0x801076f2,(%esp)
...
80106b46:	83 ec 2c             	sub    $0x2c,%esp
  ...
  if((d = setupkvm()) == 0)
80106b49:	e8 62 fb ff ff       	call   801066b0 <setupkvm>
...
80106b9c:	e8 af f8 ff ff       	call   80106450 <mappages>
...
80106bb7:	e8 04 f8 ff ff       	call   801063c0 <walkpgdir>
...
80106c0d:	eb e4                	jmp    80106bf3 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    ...
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106c0f:	c7 04 24 16 77 10 80 	movl   $0x80107716,(%esp)
80106c16:	e8 45 97 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106c1b:	c7 04 24 fc 76 10 80 	movl   $0x801076fc,(%esp)
...
80106c3e:	e8 7d f7 ff ff       	call   801063c0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106d09:	c7 04 24 54 77 10 80 	movl   $0x80107754,(%esp)
80106d10:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d14:	e8 37 99 ff ff       	call   80100650 <cprintf>
    return 0xABCDABCD;
}
80106d19:	b8 cd ab cd ab       	mov    $0xabcdabcd,%eax
80106d1e:	c9                   	leave  
80106d1f:	c3                   	ret    

80106d20 <sys_my_syscall>:
...
80106d34:	e8 57 d9 ff ff       	call   80104690 <argstr>
        return -1;
80106d39:	ba ff ff ff ff       	mov    $0xffffffff,%edx
...
80106d40:	78 18                	js     80106d5a <sys_my_syscall+0x3a>
#include "defs.h"
...
80106d45:	c7 04 24 54 77 10 80 	movl   $0x80107754,(%esp)
80106d4c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d50:	e8 fb 98 ff ff       	call   80100650 <cprintf>
sys_my_syscall(void) 
{
    char *str;
    if (argstr(0, &str) < 0) // wrapper 함수. 커널 내부에 reference가 호출 되고, argument가 user영역에 있는지 체크해주는 함수.
...
80106d55:	ba cd ab cd ab       	mov    $0xabcdabcd,%edx
}
80106d5a:	89 d0                	mov    %edx,%eax
80106d5c:	c9                   	leave  
80106d5d:	c3                   	ret    
...
{
    return proc->parent->pid;
80106d6a:	8b 40 14             	mov    0x14(%eax),%eax
80106d6d:	8b 40 10             	mov    0x10(%eax),%eax
}
80106d70:	c3                   	ret    
80106d71:	eb 0d                	jmp    80106d80 <sys_getppid>
80106d73:	90                   	nop
80106d74:	90                   	nop
80106d75:	90                   	nop
80106d76:	90                   	nop
...
{
    return proc->parent->pid;
80106d8a:	8b 40 14             	mov    0x14(%eax),%eax
}
...
{
    return getppid();
80106d8d:	8b 40 10             	mov    0x10(%eax),%eax
}
80106d90:	c3                   	ret    
