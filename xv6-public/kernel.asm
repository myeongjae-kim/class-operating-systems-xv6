...
80100382:	c7 04 24 0d 6e 10 80 	movl   $0x80106e0d,(%esp)
...
80100398:	e8 b3 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
8010039d:	c7 04 24 06 73 10 80 	movl   $0x80107306,(%esp)
...
801003bd:	c7 04 24 29 6e 10 80 	movl   $0x80106e29,(%esp)
...
80100525:	e9 59 ff ff ff       	jmp    80100483 <consputc+0xa3>
  ...
  if(pos < 0 || pos > 25*80)
    panic("pos under/overflow");
8010052a:	c7 04 24 2d 6e 10 80 	movl   $0x80106e2d,(%esp)
...
80100599:	0f b6 92 58 6e 10 80 	movzbl -0x7fef91a8(%edx),%edx
  }while((x /= base) != 0);
...
8010075d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        s = "(null)";
80100760:	b8 40 6e 10 80       	mov    $0x80106e40,%eax
...
8010079c:	e9 c8 fe ff ff       	jmp    80100669 <cprintf+0x19>
  ...
  if (fmt == 0)
    panic("null fmt");
801007a1:	c7 04 24 47 6e 10 80 	movl   $0x80106e47,(%esp)
...
80100956:	c7 44 24 04 50 6e 10 	movl   $0x80106e50,0x4(%esp)
8010095d:	80 
...
80100a2a:	75 d5                	jne    80100a01 <exec+0x51>
  ...
  if((pgdir = setupkvm()) == 0)
80100a2c:	e8 bf 5c 00 00       	call   801066f0 <setupkvm>
...
80100bad:	e8 9e 5f 00 00       	call   80106b50 <clearpteu>
  sp = sz;
...
80100be9:	e8 62 39 00 00       	call   80104550 <strlen>
...
80100bfa:	e8 51 39 00 00       	call   80104550 <strlen>
...
80100c19:	e8 92 60 00 00       	call   80106cb0 <copyout>
...
80100c86:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c8c:	e8 1f 60 00 00       	call   80106cb0 <copyout>
...
80100cd7:	e8 34 38 00 00       	call   80104510 <safestrcpy>
...
80100d11:	e8 9a 5a 00 00       	call   801067b0 <switchuvm>
  freevm(oldpgdir);
80100d16:	89 34 24             	mov    %esi,(%esp)
80100d19:	e8 b2 5d 00 00       	call   80106ad0 <freevm>
  return 0;
...
80100d46:	c7 44 24 04 69 6e 10 	movl   $0x80106e69,0x4(%esp)
80100d4d:	80 
...
filedup(struct file *f)
{
  ...
  if(f->ref < 1)
    panic("filedup");
80100e07:	c7 04 24 70 6e 10 80 	movl   $0x80106e70,(%esp)
...
80100ec7:	e9 24 1d 00 00       	jmp    80102bf0 <end_op>
{
  ...
  if(f->ref < 1)
    panic("fileclose");
80100ecc:	c7 04 24 78 6e 10 80 	movl   $0x80106e78,(%esp)
...
80100fb5:	eb d8                	jmp    80100f8f <fileread+0x5f>
  ...
  panic("fileread");
80100fb7:	c7 04 24 82 6e 10 80 	movl   $0x80106e82,(%esp)
...
801010cc:	e9 5f 23 00 00       	jmp    80103430 <pipewrite>
      ...
      if(r != n1)
        panic("short filewrite");
801010d1:	c7 04 24 8b 6e 10 80 	movl   $0x80106e8b,(%esp)
801010d8:	e8 83 f2 ff ff       	call   80100360 <panic>
  ...
  panic("filewrite");
801010dd:	c7 04 24 91 6e 10 80 	movl   $0x80106e91,(%esp)
...
80101195:	c7 04 24 9b 6e 10 80 	movl   $0x80106e9b,(%esp)
...
801012bc:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
801012bd:	c7 04 24 b1 6e 10 80 	movl   $0x80106eb1,(%esp)
...
80101375:	eb 93                	jmp    8010130a <bmap+0x3a>
  ...
  panic("bmap: out of range");
80101377:	c7 04 24 c1 6e 10 80 	movl   $0x80106ec1,(%esp)
...
80101458:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
80101459:	c7 04 24 d4 6e 10 80 	movl   $0x80106ed4,(%esp)
...
8010147c:	c7 44 24 04 e7 6e 10 	movl   $0x80106ee7,0x4(%esp)
80101483:	80 
...
80101499:	c7 44 24 04 ee 6e 10 	movl   $0x80106eee,0x4(%esp)
801014a0:	80 
...
801014c6:	c7 04 24 44 6f 10 80 	movl   $0x80106f44,(%esp)
...
801015dc:	e9 2f fc ff ff       	jmp    80101210 <iget>
  ...
  panic("ialloc: no inodes");
801015e1:	c7 04 24 f4 6e 10 80 	movl   $0x80106ef4,(%esp)
...
80101761:	0f 85 78 ff ff ff    	jne    801016df <ilock+0x2f>
      panic("ilock: no type");
80101767:	c7 04 24 0c 6f 10 80 	movl   $0x80106f0c,(%esp)
8010176e:	e8 ed eb ff ff       	call   80100360 <panic>
{
  ...
  if(ip == 0 || ip->ref < 1)
    panic("ilock");
80101773:	c7 04 24 06 6f 10 80 	movl   $0x80106f06,(%esp)
...
iunlock(struct inode *ip)
{
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    panic("iunlock");
801017b3:	c7 04 24 1b 6f 10 80 	movl   $0x80106f1b,(%esp)
...
80101c41:	c3                   	ret    
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101c42:	c7 04 24 35 6f 10 80 	movl   $0x80106f35,(%esp)
80101c49:	e8 12 e7 ff ff       	call   80100360 <panic>
{
  ...
  if(dp->type != T_DIR)
    panic("dirlookup not DIR");
80101c4e:	c7 04 24 23 6f 10 80 	movl   $0x80106f23,(%esp)
...
80101ec3:	eb e9                	jmp    80101eae <dirlink+0xae>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101ec5:	c7 04 24 35 6f 10 80 	movl   $0x80106f35,(%esp)
80101ecc:	e8 8f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101ed1:	c7 04 24 06 75 10 80 	movl   $0x80107506,(%esp)
...
80101fbf:	c7 04 24 a0 6f 10 80 	movl   $0x80106fa0,(%esp)
...
idestart(struct buf *b)
{
  if(b == 0)
    panic("idestart");
80101fcb:	c7 04 24 97 6f 10 80 	movl   $0x80106f97,(%esp)
...
80101fe6:	c7 44 24 04 b2 6f 10 	movl   $0x80106fb2,0x4(%esp)
80101fed:	80 
...
iderw(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    panic("iderw: buf not locked");
801021cb:	c7 04 24 b6 6f 10 80 	movl   $0x80106fb6,(%esp)
801021d2:	e8 89 e1 ff ff       	call   80100360 <panic>
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
  if(b->dev != 0 && !havedisk1)
    panic("iderw: ide disk 1 not present");
801021d7:	c7 04 24 e1 6f 10 80 	movl   $0x80106fe1,(%esp)
801021de:	e8 7d e1 ff ff       	call   80100360 <panic>
  ...
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
801021e3:	c7 04 24 cc 6f 10 80 	movl   $0x80106fcc,(%esp)
...
80102245:	c7 04 24 00 70 10 80 	movl   $0x80107000,(%esp)
...
kfree(char *v)
{
  ...
  if((uint)v % PGSIZE || v < end || V2P(v) >= PHYSTOP)
    panic("kfree");
8010236e:	c7 04 24 32 70 10 80 	movl   $0x80107032,(%esp)
...
801023db:	c7 44 24 04 38 70 10 	movl   $0x80107038,0x4(%esp)
801023e2:	80 
...
801027be:	c7 04 24 60 72 10 80 	movl   $0x80107260,(%esp)
...
801027df:	c3                   	ret    
  ...
  panic("unknown apicid\n");
801027e0:	c7 04 24 8c 72 10 80 	movl   $0x8010728c,(%esp)
...
80102aeb:	c7 44 24 04 9c 72 10 	movl   $0x8010729c,0x4(%esp)
80102af2:	80 
...
80102d12:	c3                   	ret    
  ...
  if(log.committing)
    panic("log.committing");
80102d13:	c7 04 24 a0 72 10 80 	movl   $0x801072a0,(%esp)
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    panic("too big a transaction");
80102dd0:	c7 04 24 af 72 10 80 	movl   $0x801072af,(%esp)
80102dd7:	e8 84 d5 ff ff       	call   80100360 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102ddc:	c7 04 24 c5 72 10 80 	movl   $0x801072c5,(%esp)
...
80102dfb:	c7 04 24 e0 72 10 80 	movl   $0x801072e0,(%esp)
...
80102e36:	e8 55 39 00 00       	call   80106790 <switchkvm>
  seginit();
80102e3b:	e8 70 37 00 00       	call   801065b0 <seginit>
  lapicinit();
...
80102e80:	e8 2b 37 00 00       	call   801065b0 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpunum());
80102e85:	e8 c6 f8 ff ff       	call   80102750 <cpunum>
80102e8a:	c7 04 24 f1 72 10 80 	movl   $0x801072f1,(%esp)
...
80102ea9:	e8 12 2a 00 00       	call   801058c0 <uartinit>
...
8010308a:	00 
8010308b:	c7 44 24 04 0d 73 10 	movl   $0x8010730d,0x4(%esp)
80103092:	80 
...
80103118:	ff 24 95 14 73 10 80 	jmp    *-0x7fef8cec(,%edx,4)
8010311f:	90                   	nop
...
8010331f:	c7 44 24 04 28 73 10 	movl   $0x80107328,0x4(%esp)
80103326:	80 
...
80103756:	c7 44 24 04 2d 73 10 	movl   $0x8010732d,0x4(%esp)
8010375d:	80 
...
80103783:	e8 68 2f 00 00       	call   801066f0 <setupkvm>
...
801037a5:	80 
801037a6:	e8 d5 30 00 00       	call   80106880 <inituvm>
  p->sz = PGSIZE;
...
80103822:	00 
80103823:	c7 44 24 04 4d 73 10 	movl   $0x8010734d,0x4(%esp)
8010382a:	80 
8010382b:	89 04 24             	mov    %eax,(%esp)
8010382e:	e8 dd 0c 00 00       	call   80104510 <safestrcpy>
  p->cwd = namei("/");
80103833:	c7 04 24 56 73 10 80 	movl   $0x80107356,(%esp)
...
80103866:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
80103867:	c7 04 24 34 73 10 80 	movl   $0x80107334,(%esp)
...
801038a7:	e8 14 31 00 00       	call   801069c0 <allocuvm>
...
801038c2:	e8 e9 2e 00 00       	call   801067b0 <switchuvm>
  return 0;
...
801038e2:	e8 c9 31 00 00       	call   80106ab0 <deallocuvm>
...
8010392a:	e8 51 32 00 00       	call   80106b80 <copyuvm>
...
80103a5b:	83 c3 7c             	add    $0x7c,%ebx
      ...
      proc = p;
      switchuvm(p);
80103a5e:	e8 4d 2d 00 00       	call   801067b0 <switchuvm>
      p->state = RUNNING;
...
80103a7d:	e8 e9 0a 00 00       	call   8010456b <swtch>
      switchkvm();
80103a82:	e8 09 2d 00 00       	call   80106790 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
sched(void)
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103b24:	c7 04 24 58 73 10 80 	movl   $0x80107358,(%esp)
80103b2b:	e8 30 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103b30:	c7 04 24 84 73 10 80 	movl   $0x80107384,(%esp)
80103b37:	e8 24 c8 ff ff       	call   80100360 <panic>
  ...
  if(proc->state == RUNNING)
    panic("sched running");
80103b3c:	c7 04 24 76 73 10 80 	movl   $0x80107376,(%esp)
80103b43:	e8 18 c8 ff ff       	call   80100360 <panic>
  ...
  if(cpu->ncli != 1)
    panic("sched locks");
80103b48:	c7 04 24 6a 73 10 80 	movl   $0x8010736a,(%esp)
...
80103c6d:	e8 4e fe ff ff       	call   80103ac0 <sched>
  panic("zombie exit");
80103c72:	c7 04 24 a5 73 10 80 	movl   $0x801073a5,(%esp)
80103c79:	e8 e2 c6 ff ff       	call   80100360 <panic>
{
  ...
  if(proc == initproc)
    panic("init exiting");
80103c7e:	c7 04 24 98 73 10 80 	movl   $0x80107398,(%esp)
...
80103d6b:	c7 04 24 b7 73 10 80 	movl   $0x801073b7,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  if(proc == 0)
    panic("sleep");
80103d77:	c7 04 24 b1 73 10 80 	movl   $0x801073b1,(%esp)
...
80103e18:	e8 b3 2c 00 00       	call   80106ad0 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103f64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f68:	c7 04 24 06 73 10 80 	movl   $0x80107306,(%esp)
...
80103f8a:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103f8d:	ba c8 73 10 80       	mov    $0x801073c8,%edx
  uint pc[10];
...
80103f94:	8b 14 85 00 74 10 80 	mov    -0x7fef8c00(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103f9b:	b8 c8 73 10 80       	mov    $0x801073c8,%eax
...
80103fb0:	c7 04 24 cc 73 10 80 	movl   $0x801073cc,(%esp)
...
80103ff9:	c7 04 24 29 6e 10 80 	movl   $0x80106e29,(%esp)
...
8010402a:	c7 44 24 04 18 74 10 	movl   $0x80107418,0x4(%esp)
80104031:	80 
...
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
8010422a:	c7 04 24 23 74 10 80 	movl   $0x80107423,(%esp)
...
popcli(void)
{
  ...
  if(--cpu->ncli < 0)
    panic("popcli");
801042c5:	c7 04 24 42 74 10 80 	movl   $0x80107442,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
801042d1:	c7 04 24 2b 74 10 80 	movl   $0x8010742b,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
801042fb:	c7 04 24 49 74 10 80 	movl   $0x80107449,(%esp)
...
80104727:	83 f9 16             	cmp    $0x16,%ecx
8010472a:	77 1c                	ja     80104748 <syscall+0x38>
8010472c:	8b 0c 85 80 74 10 80 	mov    -0x7fef8b80(,%eax,4),%ecx
...
80104756:	c7 04 24 51 74 10 80 	movl   $0x80107451,(%esp)
...
801048a0:	c7 44 24 04 fc 74 10 	movl   $0x801074fc,0x4(%esp)
801048a7:	80 
...
801048bb:	c7 44 24 04 fb 74 10 	movl   $0x801074fb,0x4(%esp)
801048c2:	80 
...
801048d1:	79 89                	jns    8010485c <create+0xdc>
      panic("create dots");
801048d3:	c7 04 24 ef 74 10 80 	movl   $0x801074ef,(%esp)
801048da:	e8 81 ba ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
801048df:	c7 04 24 fe 74 10 80 	movl   $0x801074fe,(%esp)
801048e6:	e8 75 ba ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
801048eb:	c7 04 24 e0 74 10 80 	movl   $0x801074e0,(%esp)
...
80104ca1:	c7 44 24 04 fc 74 10 	movl   $0x801074fc,0x4(%esp)
80104ca8:	80 
...
80104cb9:	c7 44 24 04 fb 74 10 	movl   $0x801074fb,0x4(%esp)
80104cc0:	80 
...
80104e08:	e9 48 ff ff ff       	jmp    80104d55 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104e0d:	c7 04 24 20 75 10 80 	movl   $0x80107520,(%esp)
80104e14:	e8 47 b5 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104e19:	c7 04 24 32 75 10 80 	movl   $0x80107532,(%esp)
80104e20:	e8 3b b5 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104e25:	c7 04 24 0e 75 10 80 	movl   $0x8010750e,(%esp)
...
801054a4:	54                   	push   %esp
  call trap
801054a5:	e8 16 01 00 00       	call   801055c0 <trap>
  addl $4, %esp
...
80105519:	b9 08 00 00 00       	mov    $0x8,%ecx

  initlock(&tickslock, "time");
8010551e:	c7 44 24 04 41 75 10 	movl   $0x80107541,0x4(%esp)
80105525:	80 
80105526:	c7 04 24 e0 4c 11 80 	movl   $0x80114ce0,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010552d:	66 a3 20 4f 11 80    	mov    %ax,0x80114f20
80105533:	c1 e8 10             	shr    $0x10,%eax
80105536:	66 a3 26 4f 11 80    	mov    %ax,0x80114f26
  SETGATE(idt[T_USER_INT], 1, SEG_KCODE<<3, vectors[T_USER_INT], DPL_USER);
8010553c:	a1 0c a2 10 80       	mov    0x8010a20c,%eax
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105541:	66 89 15 22 4f 11 80 	mov    %dx,0x80114f22
80105548:	c6 05 24 4f 11 80 00 	movb   $0x0,0x80114f24
8010554f:	c6 05 25 4f 11 80 ef 	movb   $0xef,0x80114f25
  SETGATE(idt[T_USER_INT], 1, SEG_KCODE<<3, vectors[T_USER_INT], DPL_USER);
80105556:	66 a3 20 51 11 80    	mov    %ax,0x80115120
8010555c:	c1 e8 10             	shr    $0x10,%eax
8010555f:	66 89 0d 22 51 11 80 	mov    %cx,0x80115122
80105566:	c6 05 24 51 11 80 00 	movb   $0x0,0x80115124
8010556d:	c6 05 25 51 11 80 ef 	movb   $0xef,0x80115125
80105574:	66 a3 26 51 11 80    	mov    %ax,0x80115126

  initlock(&tickslock, "time");
8010557a:	e8 b1 eb ff ff       	call   80104130 <initlock>
}
8010557f:	c9                   	leave  
80105580:	c3                   	ret    
80105581:	eb 0d                	jmp    80105590 <idtinit>
80105583:	90                   	nop
80105584:	90                   	nop
80105585:	90                   	nop
80105586:	90                   	nop
...
801055d2:	74 1c                	je     801055f0 <trap+0x30>
    if(proc->killed)
      exit();
    return;
  }
...
801055d4:	3d 80 00 00 00       	cmp    $0x80,%eax
801055d9:	74 45                	je     80105620 <trap+0x60>
  ...
  switch(tf->trapno){
801055db:	83 e8 20             	sub    $0x20,%eax
801055de:	83 f8 1f             	cmp    $0x1f,%eax
801055e1:	0f 87 31 01 00 00    	ja     80105718 <trap+0x158>
801055e7:	ff 24 85 04 76 10 80 	jmp    *-0x7fef89fc(,%eax,4)
...
801055f6:	8b 70 24             	mov    0x24(%eax),%esi
801055f9:	85 f6                	test   %esi,%esi
801055fb:	0f 85 07 01 00 00    	jne    80105708 <trap+0x148>
      exit();
    proc->tf = tf;
80105601:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105604:	e8 07 f1 ff ff       	call   80104710 <syscall>
    if(proc->killed)
80105609:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010560f:	8b 58 24             	mov    0x24(%eax),%ebx
80105612:	85 db                	test   %ebx,%ebx
80105614:	75 16                	jne    8010562c <trap+0x6c>
    yield();
...
80105616:	83 c4 2c             	add    $0x2c,%esp
80105619:	5b                   	pop    %ebx
8010561a:	5e                   	pop    %esi
8010561b:	5f                   	pop    %edi
8010561c:	5d                   	pop    %ebp
...
8010561e:	66 90                	xchg   %ax,%ax
  ...
  if(tf->trapno == T_USER_INT){
      cprintf("user interrupt 128 called!\n");
80105620:	c7 04 24 46 75 10 80 	movl   $0x80107546,(%esp)
80105627:	e8 24 b0 ff ff       	call   80100650 <cprintf>
    yield();
...
8010562c:	83 c4 2c             	add    $0x2c,%esp
8010562f:	5b                   	pop    %ebx
80105630:	5e                   	pop    %esi
80105631:	5f                   	pop    %edi
80105632:	5d                   	pop    %ebp
  ...
  if(tf->trapno == T_USER_INT){
      cprintf("user interrupt 128 called!\n");
      exit();
80105633:	e9 28 e5 ff ff       	jmp    80103b60 <exit>
    return;
  }
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
80105638:	e8 13 d1 ff ff       	call   80102750 <cpunum>
8010563d:	85 c0                	test   %eax,%eax
8010563f:	0f 84 93 01 00 00    	je     801057d8 <trap+0x218>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80105645:	e8 a6 d1 ff ff       	call   801027f0 <lapiceoi>
...
80105652:	74 c2                	je     80105616 <trap+0x56>
80105654:	8b 50 24             	mov    0x24(%eax),%edx
80105657:	85 d2                	test   %edx,%edx
80105659:	0f 85 25 01 00 00    	jne    80105784 <trap+0x1c4>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
8010565f:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105663:	0f 84 47 01 00 00    	je     801057b0 <trap+0x1f0>
    yield();
...
8010566e:	74 a6                	je     80105616 <trap+0x56>
80105670:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105674:	83 e0 03             	and    $0x3,%eax
80105677:	66 83 f8 03          	cmp    $0x3,%ax
8010567b:	74 af                	je     8010562c <trap+0x6c>
    exit();
}
8010567d:	83 c4 2c             	add    $0x2c,%esp
80105680:	5b                   	pop    %ebx
80105681:	5e                   	pop    %esi
80105682:	5f                   	pop    %edi
80105683:	5d                   	pop    %ebp
...
80105685:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105688:	e8 33 cf ff ff       	call   801025c0 <kbdintr>
    lapiceoi();
8010568d:	e8 5e d1 ff ff       	call   801027f0 <lapiceoi>
80105692:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    break;
80105698:	eb b6                	jmp    80105650 <trap+0x90>
8010569a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801056a0:	e8 cb 02 00 00       	call   80105970 <uartintr>
    lapiceoi();
801056a5:	e8 46 d1 ff ff       	call   801027f0 <lapiceoi>
801056aa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    break;
801056b0:	eb 9e                	jmp    80105650 <trap+0x90>
801056b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801056b8:	8b 7b 38             	mov    0x38(%ebx),%edi
801056bb:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
801056bf:	e8 8c d0 ff ff       	call   80102750 <cpunum>
801056c4:	c7 04 24 68 75 10 80 	movl   $0x80107568,(%esp)
801056cb:	89 7c 24 0c          	mov    %edi,0xc(%esp)
801056cf:	89 74 24 08          	mov    %esi,0x8(%esp)
801056d3:	89 44 24 04          	mov    %eax,0x4(%esp)
801056d7:	e8 74 af ff ff       	call   80100650 <cprintf>
            cpunum(), tf->cs, tf->eip);
    lapiceoi();
801056dc:	e8 0f d1 ff ff       	call   801027f0 <lapiceoi>
801056e1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    break;
801056e7:	e9 64 ff ff ff       	jmp    80105650 <trap+0x90>
...
801056f0:	e8 7b c9 ff ff       	call   80102070 <ideintr>
    lapiceoi();
801056f5:	e8 f6 d0 ff ff       	call   801027f0 <lapiceoi>
801056fa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    break;
80105700:	e9 4b ff ff ff       	jmp    80105650 <trap+0x90>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(proc->killed)
      exit();
80105708:	e8 53 e4 ff ff       	call   80103b60 <exit>
8010570d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105713:	e9 e9 fe ff ff       	jmp    80105601 <trap+0x41>
    lapiceoi();
    break;
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
80105718:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
8010571f:	85 c9                	test   %ecx,%ecx
80105721:	0f 84 e1 00 00 00    	je     80105808 <trap+0x248>
80105727:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010572b:	0f 84 d7 00 00 00    	je     80105808 <trap+0x248>
...
80105734:	8b 73 38             	mov    0x38(%ebx),%esi
80105737:	e8 14 d0 ff ff       	call   80102750 <cpunum>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
8010573c:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105743:	89 7c 24 1c          	mov    %edi,0x1c(%esp)
80105747:	89 74 24 18          	mov    %esi,0x18(%esp)
8010574b:	89 44 24 14          	mov    %eax,0x14(%esp)
8010574f:	8b 43 34             	mov    0x34(%ebx),%eax
80105752:	89 44 24 10          	mov    %eax,0x10(%esp)
80105756:	8b 43 30             	mov    0x30(%ebx),%eax
80105759:	89 44 24 0c          	mov    %eax,0xc(%esp)
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
8010575d:	8d 42 6c             	lea    0x6c(%edx),%eax
80105760:	89 44 24 08          	mov    %eax,0x8(%esp)
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105764:	8b 42 10             	mov    0x10(%edx),%eax
80105767:	c7 04 24 c0 75 10 80 	movl   $0x801075c0,(%esp)
8010576e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105772:	e8 d9 ae ff ff       	call   80100650 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
            rcr2());
    proc->killed = 1;
80105777:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010577d:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
  ...
  // until it gets to the regular system call return.)
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80105784:	0f b7 53 3c          	movzwl 0x3c(%ebx),%edx
80105788:	83 e2 03             	and    $0x3,%edx
8010578b:	66 83 fa 03          	cmp    $0x3,%dx
8010578f:	0f 85 ca fe ff ff    	jne    8010565f <trap+0x9f>
    exit();
80105795:	e8 c6 e3 ff ff       	call   80103b60 <exit>
...
801057a2:	0f 85 b7 fe ff ff    	jne    8010565f <trap+0x9f>
801057a8:	e9 69 fe ff ff       	jmp    80105616 <trap+0x56>
801057ad:	8d 76 00             	lea    0x0(%esi),%esi
801057b0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
801057b4:	0f 85 af fe ff ff    	jne    80105669 <trap+0xa9>
801057ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    yield();
801057c0:	e8 cb e4 ff ff       	call   80103c90 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
801057c5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801057cb:	85 c0                	test   %eax,%eax
801057cd:	0f 85 96 fe ff ff    	jne    80105669 <trap+0xa9>
801057d3:	e9 3e fe ff ff       	jmp    80105616 <trap+0x56>
  }
...
801057df:	e8 cc e9 ff ff       	call   801041b0 <acquire>
      ticks++;
      wakeup(&ticks);
...
801057eb:	83 05 20 55 11 80 01 	addl   $0x1,0x80115520
      wakeup(&ticks);
801057f2:	e8 79 e6 ff ff       	call   80103e70 <wakeup>
      release(&tickslock);
801057f7:	c7 04 24 e0 4c 11 80 	movl   $0x80114ce0,(%esp)
801057fe:	e8 dd ea ff ff       	call   801042e0 <release>
80105803:	e9 3d fe ff ff       	jmp    80105645 <trap+0x85>
...
8010580e:	e8 3d cf ff ff       	call   80102750 <cpunum>
...
80105822:	c7 04 24 8c 75 10 80 	movl   $0x8010758c,(%esp)
80105829:	89 44 24 04          	mov    %eax,0x4(%esp)
8010582d:	e8 1e ae ff ff       	call   80100650 <cprintf>
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
80105832:	c7 04 24 62 75 10 80 	movl   $0x80107562,(%esp)
...
80105897:	e8 74 cf ff ff       	call   80102810 <microdelay>
{
  int i;
...
80105920:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  ...
  for(p="xv6...\n"; *p; p++)
80105927:	bb 84 76 10 80       	mov    $0x80107684,%ebx
  ...
  inb(COM1+0);
  picenable(IRQ_COM1);
8010592c:	e8 bf d8 ff ff       	call   801031f0 <picenable>
  ioapicenable(IRQ_COM1, 0);
80105931:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105938:	00 
80105939:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105940:	e8 5b c9 ff ff       	call   801022a0 <ioapicenable>
...
80105986:	6a 00                	push   $0x0
  jmp alltraps
80105988:	e9 00 fb ff ff       	jmp    8010548d <alltraps>
...
8010598f:	6a 01                	push   $0x1
  jmp alltraps
80105991:	e9 f7 fa ff ff       	jmp    8010548d <alltraps>
...
801059b3:	6a 05                	push   $0x5
  jmp alltraps
801059b5:	e9 d3 fa ff ff       	jmp    8010548d <alltraps>
...
801059bc:	6a 06                	push   $0x6
  jmp alltraps
801059be:	e9 ca fa ff ff       	jmp    8010548d <alltraps>
...
801059c5:	6a 07                	push   $0x7
  jmp alltraps
801059c7:	e9 c1 fa ff ff       	jmp    8010548d <alltraps>
...
801059dc:	6a 0a                	push   $0xa
  jmp alltraps
801059de:	e9 aa fa ff ff       	jmp    8010548d <alltraps>
...
801059ea:	6a 0c                	push   $0xc
  jmp alltraps
801059ec:	e9 9c fa ff ff       	jmp    8010548d <alltraps>
...
801059f1:	6a 0d                	push   $0xd
  jmp alltraps
801059f3:	e9 95 fa ff ff       	jmp    8010548d <alltraps>
...
801059f8:	6a 0e                	push   $0xe
  jmp alltraps
801059fa:	e9 8e fa ff ff       	jmp    8010548d <alltraps>
...
80105a01:	6a 0f                	push   $0xf
  jmp alltraps
80105a03:	e9 85 fa ff ff       	jmp    8010548d <alltraps>
...
80105a0a:	6a 10                	push   $0x10
  jmp alltraps
80105a0c:	e9 7c fa ff ff       	jmp    8010548d <alltraps>
...
80105a11:	6a 11                	push   $0x11
  jmp alltraps
80105a13:	e9 75 fa ff ff       	jmp    8010548d <alltraps>
...
80105a1a:	6a 12                	push   $0x12
  jmp alltraps
80105a1c:	e9 6c fa ff ff       	jmp    8010548d <alltraps>
...
80105a23:	6a 13                	push   $0x13
  jmp alltraps
80105a25:	e9 63 fa ff ff       	jmp    8010548d <alltraps>
...
80105a2c:	6a 14                	push   $0x14
  jmp alltraps
80105a2e:	e9 5a fa ff ff       	jmp    8010548d <alltraps>
...
80105a35:	6a 15                	push   $0x15
  jmp alltraps
80105a37:	e9 51 fa ff ff       	jmp    8010548d <alltraps>
...
80105a3e:	6a 16                	push   $0x16
  jmp alltraps
80105a40:	e9 48 fa ff ff       	jmp    8010548d <alltraps>
...
80105a47:	6a 17                	push   $0x17
  jmp alltraps
80105a49:	e9 3f fa ff ff       	jmp    8010548d <alltraps>
...
80105a50:	6a 18                	push   $0x18
  jmp alltraps
80105a52:	e9 36 fa ff ff       	jmp    8010548d <alltraps>
...
80105a59:	6a 19                	push   $0x19
  jmp alltraps
80105a5b:	e9 2d fa ff ff       	jmp    8010548d <alltraps>
...
80105a62:	6a 1a                	push   $0x1a
  jmp alltraps
80105a64:	e9 24 fa ff ff       	jmp    8010548d <alltraps>
...
80105a6b:	6a 1b                	push   $0x1b
  jmp alltraps
80105a6d:	e9 1b fa ff ff       	jmp    8010548d <alltraps>
...
80105a74:	6a 1c                	push   $0x1c
  jmp alltraps
80105a76:	e9 12 fa ff ff       	jmp    8010548d <alltraps>
...
80105a7d:	6a 1d                	push   $0x1d
  jmp alltraps
80105a7f:	e9 09 fa ff ff       	jmp    8010548d <alltraps>
...
80105a86:	6a 1e                	push   $0x1e
  jmp alltraps
80105a88:	e9 00 fa ff ff       	jmp    8010548d <alltraps>
...
80105a8f:	6a 1f                	push   $0x1f
  jmp alltraps
80105a91:	e9 f7 f9 ff ff       	jmp    8010548d <alltraps>
...
80105a98:	6a 20                	push   $0x20
  jmp alltraps
80105a9a:	e9 ee f9 ff ff       	jmp    8010548d <alltraps>
...
80105aa1:	6a 21                	push   $0x21
  jmp alltraps
80105aa3:	e9 e5 f9 ff ff       	jmp    8010548d <alltraps>
...
80105aaa:	6a 22                	push   $0x22
  jmp alltraps
80105aac:	e9 dc f9 ff ff       	jmp    8010548d <alltraps>
...
80105ab3:	6a 23                	push   $0x23
  jmp alltraps
80105ab5:	e9 d3 f9 ff ff       	jmp    8010548d <alltraps>
...
80105abc:	6a 24                	push   $0x24
  jmp alltraps
80105abe:	e9 ca f9 ff ff       	jmp    8010548d <alltraps>
...
80105ac5:	6a 25                	push   $0x25
  jmp alltraps
80105ac7:	e9 c1 f9 ff ff       	jmp    8010548d <alltraps>
...
80105ace:	6a 26                	push   $0x26
  jmp alltraps
80105ad0:	e9 b8 f9 ff ff       	jmp    8010548d <alltraps>
...
80105ad7:	6a 27                	push   $0x27
  jmp alltraps
80105ad9:	e9 af f9 ff ff       	jmp    8010548d <alltraps>
...
80105ae0:	6a 28                	push   $0x28
  jmp alltraps
80105ae2:	e9 a6 f9 ff ff       	jmp    8010548d <alltraps>
...
80105ae9:	6a 29                	push   $0x29
  jmp alltraps
80105aeb:	e9 9d f9 ff ff       	jmp    8010548d <alltraps>
...
80105af2:	6a 2a                	push   $0x2a
  jmp alltraps
80105af4:	e9 94 f9 ff ff       	jmp    8010548d <alltraps>
...
80105afb:	6a 2b                	push   $0x2b
  jmp alltraps
80105afd:	e9 8b f9 ff ff       	jmp    8010548d <alltraps>
...
80105b04:	6a 2c                	push   $0x2c
  jmp alltraps
80105b06:	e9 82 f9 ff ff       	jmp    8010548d <alltraps>
...
80105b0d:	6a 2d                	push   $0x2d
  jmp alltraps
80105b0f:	e9 79 f9 ff ff       	jmp    8010548d <alltraps>
...
80105b16:	6a 2e                	push   $0x2e
  jmp alltraps
80105b18:	e9 70 f9 ff ff       	jmp    8010548d <alltraps>
...
80105b1f:	6a 2f                	push   $0x2f
  jmp alltraps
80105b21:	e9 67 f9 ff ff       	jmp    8010548d <alltraps>
...
80105b28:	6a 30                	push   $0x30
  jmp alltraps
80105b2a:	e9 5e f9 ff ff       	jmp    8010548d <alltraps>
...
80105b31:	6a 31                	push   $0x31
  jmp alltraps
80105b33:	e9 55 f9 ff ff       	jmp    8010548d <alltraps>
...
80105b3a:	6a 32                	push   $0x32
  jmp alltraps
80105b3c:	e9 4c f9 ff ff       	jmp    8010548d <alltraps>
...
80105b43:	6a 33                	push   $0x33
  jmp alltraps
80105b45:	e9 43 f9 ff ff       	jmp    8010548d <alltraps>
...
80105b4c:	6a 34                	push   $0x34
  jmp alltraps
80105b4e:	e9 3a f9 ff ff       	jmp    8010548d <alltraps>
...
80105b55:	6a 35                	push   $0x35
  jmp alltraps
80105b57:	e9 31 f9 ff ff       	jmp    8010548d <alltraps>
...
80105b5e:	6a 36                	push   $0x36
  jmp alltraps
80105b60:	e9 28 f9 ff ff       	jmp    8010548d <alltraps>
...
80105b67:	6a 37                	push   $0x37
  jmp alltraps
80105b69:	e9 1f f9 ff ff       	jmp    8010548d <alltraps>
...
80105b70:	6a 38                	push   $0x38
  jmp alltraps
80105b72:	e9 16 f9 ff ff       	jmp    8010548d <alltraps>
...
80105b79:	6a 39                	push   $0x39
  jmp alltraps
80105b7b:	e9 0d f9 ff ff       	jmp    8010548d <alltraps>
...
80105b82:	6a 3a                	push   $0x3a
  jmp alltraps
80105b84:	e9 04 f9 ff ff       	jmp    8010548d <alltraps>
...
80105b8b:	6a 3b                	push   $0x3b
  jmp alltraps
80105b8d:	e9 fb f8 ff ff       	jmp    8010548d <alltraps>
...
80105b94:	6a 3c                	push   $0x3c
  jmp alltraps
80105b96:	e9 f2 f8 ff ff       	jmp    8010548d <alltraps>
...
80105b9d:	6a 3d                	push   $0x3d
  jmp alltraps
80105b9f:	e9 e9 f8 ff ff       	jmp    8010548d <alltraps>
...
80105ba6:	6a 3e                	push   $0x3e
  jmp alltraps
80105ba8:	e9 e0 f8 ff ff       	jmp    8010548d <alltraps>
...
80105baf:	6a 3f                	push   $0x3f
  jmp alltraps
80105bb1:	e9 d7 f8 ff ff       	jmp    8010548d <alltraps>
...
80105bb8:	6a 40                	push   $0x40
  jmp alltraps
80105bba:	e9 ce f8 ff ff       	jmp    8010548d <alltraps>
...
80105bc1:	6a 41                	push   $0x41
  jmp alltraps
80105bc3:	e9 c5 f8 ff ff       	jmp    8010548d <alltraps>
...
80105bca:	6a 42                	push   $0x42
  jmp alltraps
80105bcc:	e9 bc f8 ff ff       	jmp    8010548d <alltraps>
...
80105bd3:	6a 43                	push   $0x43
  jmp alltraps
80105bd5:	e9 b3 f8 ff ff       	jmp    8010548d <alltraps>
...
80105bdc:	6a 44                	push   $0x44
  jmp alltraps
80105bde:	e9 aa f8 ff ff       	jmp    8010548d <alltraps>
...
80105be5:	6a 45                	push   $0x45
  jmp alltraps
80105be7:	e9 a1 f8 ff ff       	jmp    8010548d <alltraps>
...
80105bee:	6a 46                	push   $0x46
  jmp alltraps
80105bf0:	e9 98 f8 ff ff       	jmp    8010548d <alltraps>
...
80105bf7:	6a 47                	push   $0x47
  jmp alltraps
80105bf9:	e9 8f f8 ff ff       	jmp    8010548d <alltraps>
...
80105c00:	6a 48                	push   $0x48
  jmp alltraps
80105c02:	e9 86 f8 ff ff       	jmp    8010548d <alltraps>
...
80105c09:	6a 49                	push   $0x49
  jmp alltraps
80105c0b:	e9 7d f8 ff ff       	jmp    8010548d <alltraps>
...
80105c12:	6a 4a                	push   $0x4a
  jmp alltraps
80105c14:	e9 74 f8 ff ff       	jmp    8010548d <alltraps>
...
80105c1b:	6a 4b                	push   $0x4b
  jmp alltraps
80105c1d:	e9 6b f8 ff ff       	jmp    8010548d <alltraps>
...
80105c24:	6a 4c                	push   $0x4c
  jmp alltraps
80105c26:	e9 62 f8 ff ff       	jmp    8010548d <alltraps>
...
80105c2d:	6a 4d                	push   $0x4d
  jmp alltraps
80105c2f:	e9 59 f8 ff ff       	jmp    8010548d <alltraps>
...
80105c36:	6a 4e                	push   $0x4e
  jmp alltraps
80105c38:	e9 50 f8 ff ff       	jmp    8010548d <alltraps>
...
80105c3f:	6a 4f                	push   $0x4f
  jmp alltraps
80105c41:	e9 47 f8 ff ff       	jmp    8010548d <alltraps>
...
80105c48:	6a 50                	push   $0x50
  jmp alltraps
80105c4a:	e9 3e f8 ff ff       	jmp    8010548d <alltraps>
...
80105c51:	6a 51                	push   $0x51
  jmp alltraps
80105c53:	e9 35 f8 ff ff       	jmp    8010548d <alltraps>
...
80105c5a:	6a 52                	push   $0x52
  jmp alltraps
80105c5c:	e9 2c f8 ff ff       	jmp    8010548d <alltraps>
...
80105c63:	6a 53                	push   $0x53
  jmp alltraps
80105c65:	e9 23 f8 ff ff       	jmp    8010548d <alltraps>
...
80105c6c:	6a 54                	push   $0x54
  jmp alltraps
80105c6e:	e9 1a f8 ff ff       	jmp    8010548d <alltraps>
...
80105c75:	6a 55                	push   $0x55
  jmp alltraps
80105c77:	e9 11 f8 ff ff       	jmp    8010548d <alltraps>
...
80105c7e:	6a 56                	push   $0x56
  jmp alltraps
80105c80:	e9 08 f8 ff ff       	jmp    8010548d <alltraps>
...
80105c87:	6a 57                	push   $0x57
  jmp alltraps
80105c89:	e9 ff f7 ff ff       	jmp    8010548d <alltraps>
...
80105c90:	6a 58                	push   $0x58
  jmp alltraps
80105c92:	e9 f6 f7 ff ff       	jmp    8010548d <alltraps>
...
80105c99:	6a 59                	push   $0x59
  jmp alltraps
80105c9b:	e9 ed f7 ff ff       	jmp    8010548d <alltraps>
...
80105ca2:	6a 5a                	push   $0x5a
  jmp alltraps
80105ca4:	e9 e4 f7 ff ff       	jmp    8010548d <alltraps>
...
80105cab:	6a 5b                	push   $0x5b
  jmp alltraps
80105cad:	e9 db f7 ff ff       	jmp    8010548d <alltraps>
...
80105cb4:	6a 5c                	push   $0x5c
  jmp alltraps
80105cb6:	e9 d2 f7 ff ff       	jmp    8010548d <alltraps>
...
80105cbd:	6a 5d                	push   $0x5d
  jmp alltraps
80105cbf:	e9 c9 f7 ff ff       	jmp    8010548d <alltraps>
...
80105cc6:	6a 5e                	push   $0x5e
  jmp alltraps
80105cc8:	e9 c0 f7 ff ff       	jmp    8010548d <alltraps>
...
80105ccf:	6a 5f                	push   $0x5f
  jmp alltraps
80105cd1:	e9 b7 f7 ff ff       	jmp    8010548d <alltraps>
...
80105cd8:	6a 60                	push   $0x60
  jmp alltraps
80105cda:	e9 ae f7 ff ff       	jmp    8010548d <alltraps>
...
80105ce1:	6a 61                	push   $0x61
  jmp alltraps
80105ce3:	e9 a5 f7 ff ff       	jmp    8010548d <alltraps>
...
80105cea:	6a 62                	push   $0x62
  jmp alltraps
80105cec:	e9 9c f7 ff ff       	jmp    8010548d <alltraps>
...
80105cf3:	6a 63                	push   $0x63
  jmp alltraps
80105cf5:	e9 93 f7 ff ff       	jmp    8010548d <alltraps>
...
80105cfc:	6a 64                	push   $0x64
  jmp alltraps
80105cfe:	e9 8a f7 ff ff       	jmp    8010548d <alltraps>
...
80105d05:	6a 65                	push   $0x65
  jmp alltraps
80105d07:	e9 81 f7 ff ff       	jmp    8010548d <alltraps>
...
80105d0e:	6a 66                	push   $0x66
  jmp alltraps
80105d10:	e9 78 f7 ff ff       	jmp    8010548d <alltraps>
...
80105d17:	6a 67                	push   $0x67
  jmp alltraps
80105d19:	e9 6f f7 ff ff       	jmp    8010548d <alltraps>
...
80105d20:	6a 68                	push   $0x68
  jmp alltraps
80105d22:	e9 66 f7 ff ff       	jmp    8010548d <alltraps>
...
80105d29:	6a 69                	push   $0x69
  jmp alltraps
80105d2b:	e9 5d f7 ff ff       	jmp    8010548d <alltraps>
...
80105d32:	6a 6a                	push   $0x6a
  jmp alltraps
80105d34:	e9 54 f7 ff ff       	jmp    8010548d <alltraps>
...
80105d3b:	6a 6b                	push   $0x6b
  jmp alltraps
80105d3d:	e9 4b f7 ff ff       	jmp    8010548d <alltraps>
...
80105d44:	6a 6c                	push   $0x6c
  jmp alltraps
80105d46:	e9 42 f7 ff ff       	jmp    8010548d <alltraps>
...
80105d4d:	6a 6d                	push   $0x6d
  jmp alltraps
80105d4f:	e9 39 f7 ff ff       	jmp    8010548d <alltraps>
...
80105d56:	6a 6e                	push   $0x6e
  jmp alltraps
80105d58:	e9 30 f7 ff ff       	jmp    8010548d <alltraps>
...
80105d5f:	6a 6f                	push   $0x6f
  jmp alltraps
80105d61:	e9 27 f7 ff ff       	jmp    8010548d <alltraps>
...
80105d68:	6a 70                	push   $0x70
  jmp alltraps
80105d6a:	e9 1e f7 ff ff       	jmp    8010548d <alltraps>
...
80105d71:	6a 71                	push   $0x71
  jmp alltraps
80105d73:	e9 15 f7 ff ff       	jmp    8010548d <alltraps>
...
80105d7a:	6a 72                	push   $0x72
  jmp alltraps
80105d7c:	e9 0c f7 ff ff       	jmp    8010548d <alltraps>
...
80105d83:	6a 73                	push   $0x73
  jmp alltraps
80105d85:	e9 03 f7 ff ff       	jmp    8010548d <alltraps>
...
80105d8c:	6a 74                	push   $0x74
  jmp alltraps
80105d8e:	e9 fa f6 ff ff       	jmp    8010548d <alltraps>
...
80105d95:	6a 75                	push   $0x75
  jmp alltraps
80105d97:	e9 f1 f6 ff ff       	jmp    8010548d <alltraps>
...
80105d9e:	6a 76                	push   $0x76
  jmp alltraps
80105da0:	e9 e8 f6 ff ff       	jmp    8010548d <alltraps>
...
80105db0:	6a 78                	push   $0x78
  jmp alltraps
80105db2:	e9 d6 f6 ff ff       	jmp    8010548d <alltraps>
...
80105db9:	6a 79                	push   $0x79
  jmp alltraps
80105dbb:	e9 cd f6 ff ff       	jmp    8010548d <alltraps>
...
80105dc2:	6a 7a                	push   $0x7a
  jmp alltraps
80105dc4:	e9 c4 f6 ff ff       	jmp    8010548d <alltraps>
...
80105dd4:	6a 7c                	push   $0x7c
  jmp alltraps
80105dd6:	e9 b2 f6 ff ff       	jmp    8010548d <alltraps>
...
80105ddd:	6a 7d                	push   $0x7d
  jmp alltraps
80105ddf:	e9 a9 f6 ff ff       	jmp    8010548d <alltraps>
...
80105de6:	6a 7e                	push   $0x7e
  jmp alltraps
80105de8:	e9 a0 f6 ff ff       	jmp    8010548d <alltraps>
...
80106398:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010639d:	e9 eb f0 ff ff       	jmp    8010548d <alltraps>
...
801063a4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801063a9:	e9 df f0 ff ff       	jmp    8010548d <alltraps>
...
801063b0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801063b5:	e9 d3 f0 ff ff       	jmp    8010548d <alltraps>
...
801063bc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801063c1:	e9 c7 f0 ff ff       	jmp    8010548d <alltraps>
...
801063c8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801063cd:	e9 bb f0 ff ff       	jmp    8010548d <alltraps>
...
801063d4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801063d9:	e9 af f0 ff ff       	jmp    8010548d <alltraps>
...
801063e0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801063e5:	e9 a3 f0 ff ff       	jmp    8010548d <alltraps>
...
801063ec:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801063f1:	e9 97 f0 ff ff       	jmp    8010548d <alltraps>
...
80106462:	e8 c9 de ff ff       	call   80104330 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106501:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80106502:	c7 04 24 8c 76 10 80 	movl   $0x8010768c,(%esp)
...
8010659a:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
8010659b:	c7 04 24 32 70 10 80 	movl   $0x80107032,(%esp)
...
801065b3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpunum()];
801065b6:	e8 95 c1 ff ff       	call   80102750 <cpunum>
...
801066f8:	e8 93 bd ff ff       	call   80102490 <kalloc>
...
8010671b:	e8 10 dc ff ff       	call   80104330 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
801067d2:	0f 84 8a 00 00 00    	je     80106862 <switchuvm+0xb2>
  ...
  pushcli();
801067d8:	e8 83 da ff ff       	call   80104260 <pushcli>
...
80106850:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106851:	e9 3a da ff ff       	jmp    80104290 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80106856:	c7 04 24 92 76 10 80 	movl   $0x80107692,(%esp)
8010685d:	e8 fe 9a ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
80106862:	c7 04 24 bd 76 10 80 	movl   $0x801076bd,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
8010686e:	c7 04 24 a8 76 10 80 	movl   $0x801076a8,(%esp)
...
8010689b:	77 54                	ja     801068f1 <inituvm+0x71>
  ...
  mem = kalloc();
8010689d:	e8 ee bb ff ff       	call   80102490 <kalloc>
  memset(mem, 0, PGSIZE);
...
801068b7:	e8 74 da ff ff       	call   80104330 <memset>
...
801068eb:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
801068ec:	e9 df da ff ff       	jmp    801043d0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
801068f1:	c7 04 24 d1 76 10 80 	movl   $0x801076d1,(%esp)
...
8010697d:	e8 be af ff ff       	call   80101940 <readi>
...
801069a1:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801069a2:	c7 04 24 eb 76 10 80 	movl   $0x801076eb,(%esp)
801069a9:	e8 b2 99 ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
801069ae:	c7 04 24 8c 77 10 80 	movl   $0x8010778c,(%esp)
...
80106a03:	e8 28 d9 ff ff       	call   80104330 <memset>
...
80106a34:	76 2a                	jbe    80106a60 <allocuvm+0xa0>
    mem = kalloc();
80106a36:	e8 55 ba ff ff       	call   80102490 <kalloc>
    if(mem == 0){
...
80106a3f:	75 af                	jne    801069f0 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106a41:	c7 04 24 09 77 10 80 	movl   $0x80107709,(%esp)
...
80106a6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106a70:	c7 04 24 21 77 10 80 	movl   $0x80107721,(%esp)
...
80106a91:	e8 4a b8 ff ff       	call   801022e0 <kfree>
      return 0;
...
80106b1d:	e8 be b7 ff ff       	call   801022e0 <kfree>
  uint i;
...
80106b32:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106b33:	e9 a8 b7 ff ff       	jmp    801022e0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106b38:	c7 04 24 3d 77 10 80 	movl   $0x8010773d,(%esp)
...
80106b6b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106b6c:	c7 04 24 4e 77 10 80 	movl   $0x8010774e,(%esp)
...
80106bbd:	e8 0e d8 ff ff       	call   801043d0 <memmove>
...
80106c15:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106c1b:	e8 70 b8 ff ff       	call   80102490 <kalloc>
...
80106c4d:	eb e4                	jmp    80106c33 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    ...
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106c4f:	c7 04 24 72 77 10 80 	movl   $0x80107772,(%esp)
80106c56:	e8 05 97 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106c5b:	c7 04 24 58 77 10 80 	movl   $0x80107758,(%esp)
...
80106cec:	e8 df d6 ff ff       	call   801043d0 <memmove>
    len -= n;
    buf += n;
...
80106d38:	5d                   	pop    %ebp
80106d39:	c3                   	ret    
80106d3a:	66 90                	xchg   %ax,%ax
80106d3c:	66 90                	xchg   %ax,%ax
...
80106d49:	c7 04 24 b0 77 10 80 	movl   $0x801077b0,(%esp)
80106d50:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d54:	e8 f7 98 ff ff       	call   80100650 <cprintf>
    return 0xABCDABCD;
}
80106d59:	b8 cd ab cd ab       	mov    $0xabcdabcd,%eax
80106d5e:	c9                   	leave  
80106d5f:	c3                   	ret    

80106d60 <sys_my_syscall>:
...
80106d74:	e8 17 d9 ff ff       	call   80104690 <argstr>
        return -1;
80106d79:	ba ff ff ff ff       	mov    $0xffffffff,%edx
...
80106d80:	78 18                	js     80106d9a <sys_my_syscall+0x3a>
#include "defs.h"
...
80106d85:	c7 04 24 b0 77 10 80 	movl   $0x801077b0,(%esp)
80106d8c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d90:	e8 bb 98 ff ff       	call   80100650 <cprintf>
sys_my_syscall(void) 
{
    char *str;
    if (argstr(0, &str) < 0) // wrapper 함수. 커널 내부에 reference가 호출 되고, argument가 user영역에 있는지 체크해주는 함수.
...
80106d95:	ba cd ab cd ab       	mov    $0xabcdabcd,%edx
}
80106d9a:	89 d0                	mov    %edx,%eax
80106d9c:	c9                   	leave  
80106d9d:	c3                   	ret    
...
{
    return proc->parent->pid;
80106daa:	8b 40 14             	mov    0x14(%eax),%eax
80106dad:	8b 40 10             	mov    0x10(%eax),%eax
}
80106db0:	c3                   	ret    
80106db1:	eb 0d                	jmp    80106dc0 <sys_getppid>
80106db3:	90                   	nop
80106db4:	90                   	nop
80106db5:	90                   	nop
80106db6:	90                   	nop
...
{
    return proc->parent->pid;
80106dca:	8b 40 14             	mov    0x14(%eax),%eax
...
{
    return getppid();
80106dcd:	8b 40 10             	mov    0x10(%eax),%eax
}
80106dd0:	c3                   	ret    
