...
main(int argc, char *argv[])
{
  ...
  16:	74 30                	je     48 <main+0x48>
        ...
        for (i = 0; i < count; ++i) {
            printf(1, "Parent\n");
  18:	c7 44 24 04 6d 07 00 	movl   $0x76d,0x4(%esp)
  1f:	00 
  20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  27:	e8 d4 03 00 00       	call   400 <printf>
            yield();
  2c:	e8 11 03 00 00       	call   342 <yield>
            printf(1, "Child\n");
            yield();
        }
    } else if (pid > 0) {
  ...
  45:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    if (pid == 0) {
        ...
        for (i = 0; i < count; ++i) {
            printf(1, "Child\n");
  48:	c7 44 24 04 66 07 00 	movl   $0x766,0x4(%esp)
  4f:	00 
  50:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  57:	e8 a4 03 00 00       	call   400 <printf>
            yield();
  5c:	e8 e1 02 00 00       	call   342 <yield>
    uint pid, i, count = 100;
    pid = fork();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 399:	0f b6 92 7c 07 00 00 	movzbl 0x77c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 52f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 531:	b8 75 07 00 00       	mov    $0x775,%eax
...
free(void *ap)
{
 ...
 5f1:	a1 f4 09 00 00       	mov    0x9f4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 637:	89 10                	mov    %edx,(%eax)
  freep = p;
 639:	a3 f4 09 00 00       	mov    %eax,0x9f4
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 662:	a3 f4 09 00 00       	mov    %eax,0x9f4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 1d f4 09 00 00    	mov    0x9f4,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6c9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6cb:	3b 15 f4 09 00 00    	cmp    0x9f4,%edx
...
morecore(uint nu)
{
 ...
 6fd:	e8 ee fe ff ff       	call   5f0 <free>
  return freep;
 702:	8b 15 f4 09 00 00    	mov    0x9f4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 724:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 727:	89 15 f4 09 00 00    	mov    %edx,0x9f4
      return (void*)(p + 1);
 ...
 73c:	eb e9                	jmp    727 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 73e:	c7 05 f4 09 00 00 f8 	movl   $0x9f8,0x9f4
 745:	09 00 00 
    base.s.size = 0;
 748:	ba f8 09 00 00       	mov    $0x9f8,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 74d:	c7 05 f8 09 00 00 f8 	movl   $0x9f8,0x9f8
 754:	09 00 00 
    base.s.size = 0;
 757:	c7 05 fc 09 00 00 00 	movl   $0x0,0x9fc
 75e:	00 00 00 
