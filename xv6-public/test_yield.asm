...
main(int argc, char *argv[])
{
  ...
  16:	74 30                	je     48 <main+0x48>
        ...
        for (i = 0; i < count; ++i) {
            printf(1, "Parent\n");
  18:	c7 44 24 04 8d 07 00 	movl   $0x78d,0x4(%esp)
  1f:	00 
  20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  27:	e8 f4 03 00 00       	call   420 <printf>
            yield();
  ...
  45:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    if (pid == 0) {
        ...
        for (i = 0; i < count; ++i) {
            printf(1, "Child\n");
  48:	c7 44 24 04 86 07 00 	movl   $0x786,0x4(%esp)
  4f:	00 
...
putc(int fd, char c)
{
 ...
 54f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 551:	b8 95 07 00 00       	mov    $0x795,%eax
...
free(void *ap)
{
 ...
 611:	a1 14 0a 00 00       	mov    0xa14,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 657:	89 10                	mov    %edx,(%eax)
  freep = p;
 659:	a3 14 0a 00 00       	mov    %eax,0xa14
}
 65e:	5b                   	pop    %ebx
 65f:	5e                   	pop    %esi
 660:	5f                   	pop    %edi
 ...
 67f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 682:	a3 14 0a 00 00       	mov    %eax,0xa14
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 1d 14 0a 00 00    	mov    0xa14,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6e9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6eb:	3b 15 14 0a 00 00    	cmp    0xa14,%edx
...
morecore(uint nu)
{
 ...
 71d:	e8 ee fe ff ff       	call   610 <free>
  return freep;
 722:	8b 15 14 0a 00 00    	mov    0xa14,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 744:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 747:	89 15 14 0a 00 00    	mov    %edx,0xa14
      return (void*)(p + 1);
 ...
 75c:	eb e9                	jmp    747 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 75e:	c7 05 14 0a 00 00 18 	movl   $0xa18,0xa14
 765:	0a 00 00 
    base.s.size = 0;
 768:	ba 18 0a 00 00       	mov    $0xa18,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 76d:	c7 05 18 0a 00 00 18 	movl   $0xa18,0xa18
 774:	0a 00 00 
    base.s.size = 0;
 777:	c7 05 1c 0a 00 00 00 	movl   $0x0,0xa1c
 77e:	00 00 00 
