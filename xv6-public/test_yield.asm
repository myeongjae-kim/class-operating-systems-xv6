...
main(int argc, char *argv[])
{
  ...
  16:	74 30                	je     48 <main+0x48>
        ...
        for (i = 0; i < count; ++i) {
            printf(1, "Parent\n");
  18:	c7 44 24 04 5d 07 00 	movl   $0x75d,0x4(%esp)
  1f:	00 
  20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  27:	e8 c4 03 00 00       	call   3f0 <printf>
            sys_yield();
  2c:	e8 11 03 00 00       	call   342 <sys_yield>
            printf(1, "Child\n");
            sys_yield();
        }
    } else if (pid > 0) {
  ...
  34:	75 e2                	jne    18 <main+0x18>
    ...
    wait();
  36:	e8 5f 02 00 00       	call   29a <wait>
  3b:	90                   	nop
  3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

    exit();
  40:	e8 4d 02 00 00       	call   292 <exit>
  45:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    if (pid == 0) {
        ...
        for (i = 0; i < count; ++i) {
            printf(1, "Child\n");
  48:	c7 44 24 04 56 07 00 	movl   $0x756,0x4(%esp)
  4f:	00 
  50:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  57:	e8 94 03 00 00       	call   3f0 <printf>
            sys_yield();
  5c:	e8 e1 02 00 00       	call   342 <sys_yield>
    uint pid, i, count = 100;
    pid = fork();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 389:	0f b6 92 6c 07 00 00 	movzbl 0x76c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 51f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 521:	b8 65 07 00 00       	mov    $0x765,%eax
