...
forktest(void)
{
  ...
  printf(1, "fork test\n");
  49:	c7 44 24 04 2c 04 00 	movl   $0x42c,0x4(%esp)
  50:	00 
  ...
  60:	0f 84 97 00 00 00    	je     fd <forktest+0xbd>
{
  ...
  printf(1, "fork test OK\n");
  a2:	c7 44 24 04 5e 04 00 	movl   $0x45e,0x4(%esp)
  a9:	00 
...
{
  write(fd, s, strlen(s));
  c0:	c7 04 24 6c 04 00 00 	movl   $0x46c,(%esp)
  c7:	e8 d4 00 00 00       	call   1a0 <strlen>
  cc:	c7 44 24 04 6c 04 00 	movl   $0x46c,0x4(%esp)
  d3:	00 
  ...
  for(; n > 0; n--){
    if(wait() < 0){
      printf(1, "wait stopped early\n");
  e9:	c7 44 24 04 37 04 00 	movl   $0x437,0x4(%esp)
  f0:	00 
  ...
  if(wait() != -1){
    printf(1, "wait got too many\n");
 102:	c7 44 24 04 4b 04 00 	movl   $0x44b,0x4(%esp)
 109:	00 
