...
main(int argc, char *argv[])
{
  ...
  3a:	8d 83 40 0a 00 00    	lea    0xa40(%ebx),%eax
  40:	89 44 24 04          	mov    %eax,0x4(%esp)
  44:	8b 83 40 0a 00 00    	mov    0xa40(%ebx),%eax
  4a:	89 04 24             	mov    %eax,(%esp)
  4d:	e8 98 02 00 00       	call   2ea <exec>
      printf(1, "exec failed!!\n");
  52:	c7 44 24 04 86 07 00 	movl   $0x786,0x4(%esp)
  59:	00 
  5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  61:	e8 ba 03 00 00       	call   420 <printf>
      exit();
  66:	e8 47 02 00 00       	call   2b2 <exit>
    } else {
      printf(1, "fork failed!!\n");
  6b:	c7 44 24 04 95 07 00 	movl   $0x795,0x4(%esp)
  72:	00 
  73:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  7a:	e8 a1 03 00 00       	call   420 <printf>
      exit();
  7f:	e8 2e 02 00 00       	call   2b2 <exit>
  84:	66 90                	xchg   %ax,%ax
  86:	66 90                	xchg   %ax,%ax
  88:	66 90                	xchg   %ax,%ax
  8a:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b9:	0f b6 92 c7 07 00 00 	movzbl 0x7c7(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 54f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 551:	b8 c0 07 00 00       	mov    $0x7c0,%eax
...
free(void *ap)
{
 ...
 67f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 682:	a3 64 0a 00 00       	mov    %eax,0xa64
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 1d 64 0a 00 00    	mov    0xa64,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6e9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6eb:	3b 15 64 0a 00 00    	cmp    0xa64,%edx
...
morecore(uint nu)
{
 ...
 71d:	e8 ee fe ff ff       	call   610 <free>
  return freep;
 722:	8b 15 64 0a 00 00    	mov    0xa64,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 75c:	eb e9                	jmp    747 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 75e:	c7 05 64 0a 00 00 68 	movl   $0xa68,0xa64
 765:	0a 00 00 
    base.s.size = 0;
 768:	ba 68 0a 00 00       	mov    $0xa68,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 76d:	c7 05 68 0a 00 00 68 	movl   $0xa68,0xa68
 774:	0a 00 00 
    base.s.size = 0;
 777:	c7 05 6c 0a 00 00 00 	movl   $0x0,0xa6c
 77e:	00 00 00 
