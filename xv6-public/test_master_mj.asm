...
main(int argc, char *argv[])
{
  ...
  19:	83 fb 3c             	cmp    $0x3c,%ebx
  1c:	75 ee                	jne    c <main+0xc>
  1e:	bb 3c 00 00 00       	mov    $0x3c,%ebx
  23:	90                   	nop
  ...
  38:	75 34                	jne    6e <main+0x6e>
      // child
      exec(child_argv[i][0], child_argv[i]);
  3a:	6b db 0c             	imul   $0xc,%ebx,%ebx
  3d:	8d 83 60 0a 00 00    	lea    0xa60(%ebx),%eax
  43:	89 44 24 04          	mov    %eax,0x4(%esp)
  47:	8b 83 60 0a 00 00    	mov    0xa60(%ebx),%eax
  4d:	89 04 24             	mov    %eax,(%esp)
  50:	e8 95 02 00 00       	call   2ea <exec>
      printf(1, "exec failed!!\n");
  55:	c7 44 24 04 a6 07 00 	movl   $0x7a6,0x4(%esp)
  5c:	00 
  5d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  64:	e8 d7 03 00 00       	call   440 <printf>
      exit();
  69:	e8 44 02 00 00       	call   2b2 <exit>
    } else {
      printf(1, "fork failed!!\n");
  6e:	c7 44 24 04 b5 07 00 	movl   $0x7b5,0x4(%esp)
  75:	00 
  76:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  7d:	e8 be 03 00 00       	call   440 <printf>
      exit();
  82:	e8 2b 02 00 00       	call   2b2 <exit>
  87:	66 90                	xchg   %ax,%ax
  89:	66 90                	xchg   %ax,%ax
  8b:	66 90                	xchg   %ax,%ax
  8d:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d9:	0f b6 92 d9 07 00 00 	movzbl 0x7d9(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 56f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 571:	b8 d2 07 00 00       	mov    $0x7d2,%eax
...
free(void *ap)
{
 ...
 631:	a1 30 0d 00 00       	mov    0xd30,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 677:	89 10                	mov    %edx,(%eax)
  freep = p;
 679:	a3 30 0d 00 00       	mov    %eax,0xd30
}
 67e:	5b                   	pop    %ebx
 67f:	5e                   	pop    %esi
 680:	5f                   	pop    %edi
 ...
 69f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 6a2:	a3 30 0d 00 00       	mov    %eax,0xd30
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 1d 30 0d 00 00    	mov    0xd30,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 709:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 70b:	3b 15 30 0d 00 00    	cmp    0xd30,%edx
...
morecore(uint nu)
{
 ...
 72a:	e8 0b fc ff ff       	call   33a <sbrk>
  if(p == (char*)-1)
 ...
 73d:	e8 ee fe ff ff       	call   630 <free>
  return freep;
 742:	8b 15 30 0d 00 00    	mov    0xd30,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 764:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 767:	89 15 30 0d 00 00    	mov    %edx,0xd30
      return (void*)(p + 1);
 ...
 77c:	eb e9                	jmp    767 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 77e:	c7 05 30 0d 00 00 34 	movl   $0xd34,0xd30
 785:	0d 00 00 
    base.s.size = 0;
 788:	ba 34 0d 00 00       	mov    $0xd34,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 78d:	c7 05 34 0d 00 00 34 	movl   $0xd34,0xd34
 794:	0d 00 00 
    base.s.size = 0;
 797:	c7 05 38 0d 00 00 00 	movl   $0x0,0xd38
 79e:	00 00 00 
