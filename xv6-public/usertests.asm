...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      e5:	c7 44 24 04 12 46 00 	movl   $0x4612,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 bd 40 00 00       	call   41b2 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     108:	c7 44 24 04 21 46 00 	movl   $0x4621,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 9a 40 00 00       	call   41b2 <printf>
    exit();
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1b4:	c7 44 24 04 42 46 00 	movl   $0x4642,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 ee 3f 00 00       	call   41b2 <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     1d1:	c7 44 24 04 54 46 00 	movl   $0x4654,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 d1 3f 00 00       	call   41b2 <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 63 46 00 00 	movl   $0x4663,(%esp)
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     1f6:	c7 44 24 04 69 46 00 	movl   $0x4669,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 ac 3f 00 00       	call   41b2 <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     21e:	c7 44 24 04 21 46 00 	movl   $0x4621,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 84 3f 00 00       	call   41b2 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 63 46 00 00 	movl   $0x4663,(%esp)
    ...
    if(fd >= 0){
     ...
     25b:	c7 44 24 04 80 46 00 	movl   $0x4680,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 47 3f 00 00       	call   41b2 <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 63 46 00 00 	movl   $0x4663,(%esp)
    ...
    printf(stdout, "unlink failed\n");
     ...
     296:	c7 44 24 04 a4 46 00 	movl   $0x46a4,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 0c 3f 00 00       	call   41b2 <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     ...
     2b5:	c7 44 24 04 b3 46 00 	movl   $0x46b3,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 ed 3e 00 00       	call   41b2 <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     2d2:	c7 44 24 04 c5 46 00 	movl   $0x46c5,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 d0 3e 00 00       	call   41b2 <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 80 45 00 00 	movl   $0x4580,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     ...
     304:	c7 44 24 04 d0 46 00 	movl   $0x46d0,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 9e 3e 00 00       	call   41b2 <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 e3 46 00 00 	movl   $0x46e3,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     346:	c7 44 24 04 f0 46 00 	movl   $0x46f0,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 5c 3e 00 00       	call   41b2 <printf>
    exit();
     356:	e8 8f 3c 00 00       	call   3fea <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 e0 64 00 00       	mov    0x64e0,%eax
     360:	c7 44 24 04 0e 47 00 	movl   $0x470e,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 42 3e 00 00       	call   41b2 <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     37d:	c7 44 24 04 1c 47 00 	movl   $0x471c,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 25 3e 00 00       	call   41b2 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 2d 47 00 00 	movl   $0x472d,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     3af:	c7 44 24 04 33 47 00 	movl   $0x4733,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 f3 3d 00 00       	call   41b2 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3d0:	c7 44 24 04 4e 47 00 	movl   $0x474e,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 d2 3d 00 00       	call   41b2 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3ec:	00 
     3ed:	c7 44 24 04 6a 47 00 	movl   $0x476a,0x4(%esp)
     3f4:	00 
     ...
     411:	c7 44 24 04 78 47 00 	movl   $0x4778,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 91 3d 00 00       	call   41b2 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 9c 47 00 	movl   $0x479c,0x4(%esp)
     435:	00 
     ...
     452:	c7 44 24 04 a8 47 00 	movl   $0x47a8,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 50 3d 00 00       	call   41b2 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     47a:	c7 44 24 04 cc 47 00 	movl   $0x47cc,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 28 3d 00 00       	call   41b2 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49c:	00 
     49d:	c7 04 24 2d 47 00 00 	movl   $0x472d,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     4b7:	c7 44 24 04 d7 47 00 	movl   $0x47d7,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 eb 3c 00 00       	call   41b2 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     4f5:	c7 44 24 04 f0 47 00 	movl   $0x47f0,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 ad 3c 00 00       	call   41b2 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     ...
     50f:	c7 44 24 04 0b 48 00 	movl   $0x480b,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 93 3c 00 00       	call   41b2 <printf>
  } else {
  ...
  if(unlink("small") < 0){
     52a:	c7 04 24 2d 47 00 00 	movl   $0x472d,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     541:	c7 44 24 04 1e 48 00 	movl   $0x481e,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 61 3c 00 00       	call   41b2 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     55b:	c7 44 24 04 2b 48 00 	movl   $0x482b,0x4(%esp)
     562:	00 
     563:	89 04 24             	mov    %eax,(%esp)
     566:	e8 47 3c 00 00       	call   41b2 <printf>
    exit();
     56b:	e8 7a 3a 00 00       	call   3fea <exit>
  }
  printf(stdout, "small file test ok\n");
     570:	a1 e0 64 00 00       	mov    0x64e0,%eax
     575:	c7 44 24 04 40 48 00 	movl   $0x4840,0x4(%esp)
     57c:	00 
     57d:	89 04 24             	mov    %eax,(%esp)
     580:	e8 2d 3c 00 00       	call   41b2 <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     592:	c7 44 24 04 54 48 00 	movl   $0x4854,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 10 3c 00 00       	call   41b2 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a2:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 64 48 00 00 	movl   $0x4864,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     5c4:	c7 44 24 04 68 48 00 	movl   $0x4868,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 de 3b 00 00       	call   41b2 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     61a:	c7 44 24 04 82 48 00 	movl   $0x4882,0x4(%esp)
     621:	00 
     622:	89 04 24             	mov    %eax,(%esp)
     625:	e8 88 3b 00 00       	call   41b2 <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     64f:	00 
     650:	c7 04 24 64 48 00 00 	movl   $0x4864,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     66a:	c7 44 24 04 a0 48 00 	movl   $0x48a0,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 38 3b 00 00       	call   41b2 <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6bf:	c7 44 24 04 b9 48 00 	movl   $0x48b9,0x4(%esp)
     6c6:	00 
     6c7:	89 04 24             	mov    %eax,(%esp)
     6ca:	e8 e3 3a 00 00       	call   41b2 <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6e0:	c7 04 24 64 48 00 00 	movl   $0x4864,(%esp)
     ...
     70b:	c7 44 24 04 d6 48 00 	movl   $0x48d6,0x4(%esp)
     712:	00 
     713:	89 04 24             	mov    %eax,(%esp)
     716:	e8 97 3a 00 00       	call   41b2 <printf>
      exit();
    ...
    if(((int*)buf)[0] != n){
     ...
     743:	c7 44 24 04 e8 48 00 	movl   $0x48e8,0x4(%esp)
     74a:	00 
     74b:	89 04 24             	mov    %eax,(%esp)
     74e:	e8 5f 3a 00 00       	call   41b2 <printf>
             n, ((int*)buf)[0]);
      exit();
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     ...
     766:	c7 44 24 04 08 49 00 	movl   $0x4908,0x4(%esp)
     76d:	00 
     76e:	89 04 24             	mov    %eax,(%esp)
     771:	e8 3c 3a 00 00       	call   41b2 <printf>
    exit();
     776:	e8 6f 38 00 00       	call   3fea <exit>
  }
  printf(stdout, "big files ok\n");
     77b:	a1 e0 64 00 00       	mov    0x64e0,%eax
     780:	c7 44 24 04 1b 49 00 	movl   $0x491b,0x4(%esp)
     787:	00 
     788:	89 04 24             	mov    %eax,(%esp)
     78b:	e8 22 3a 00 00       	call   41b2 <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     79d:	c7 44 24 04 2c 49 00 	movl   $0x492c,0x4(%esp)
     7a4:	00 
     7a5:	89 04 24             	mov    %eax,(%esp)
     7a8:	e8 05 3a 00 00       	call   41b2 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     838:	c7 44 24 04 54 49 00 	movl   $0x4954,0x4(%esp)
     83f:	00 
     840:	89 04 24             	mov    %eax,(%esp)
     843:	e8 6a 39 00 00       	call   41b2 <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     855:	c7 44 24 04 7a 49 00 	movl   $0x497a,0x4(%esp)
     85c:	00 
     85d:	89 04 24             	mov    %eax,(%esp)
     860:	e8 4d 39 00 00       	call   41b2 <printf>

  if(mkdir("dir0") < 0){
     865:	c7 04 24 86 49 00 00 	movl   $0x4986,(%esp)
     86c:	e8 e1 37 00 00       	call   4052 <mkdir>
     871:	85 c0                	test   %eax,%eax
     873:	79 1a                	jns    88f <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     875:	a1 e0 64 00 00       	mov    0x64e0,%eax
     87a:	c7 44 24 04 a9 45 00 	movl   $0x45a9,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 28 39 00 00       	call   41b2 <printf>
    exit();
     88a:	e8 5b 37 00 00       	call   3fea <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 86 49 00 00 	movl   $0x4986,(%esp)
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     8a4:	c7 44 24 04 8b 49 00 	movl   $0x498b,0x4(%esp)
     8ab:	00 
     8ac:	89 04 24             	mov    %eax,(%esp)
     8af:	e8 fe 38 00 00       	call   41b2 <printf>
    exit();
     8b4:	e8 31 37 00 00       	call   3fea <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 9e 49 00 00 	movl   $0x499e,(%esp)
     8c0:	e8 95 37 00 00       	call   405a <chdir>
     8c5:	85 c0                	test   %eax,%eax
     8c7:	79 1a                	jns    8e3 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c9:	a1 e0 64 00 00       	mov    0x64e0,%eax
     8ce:	c7 44 24 04 a1 49 00 	movl   $0x49a1,0x4(%esp)
     8d5:	00 
     8d6:	89 04 24             	mov    %eax,(%esp)
     8d9:	e8 d4 38 00 00       	call   41b2 <printf>
    exit();
     8de:	e8 07 37 00 00       	call   3fea <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 86 49 00 00 	movl   $0x4986,(%esp)
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     8f8:	c7 44 24 04 b2 49 00 	movl   $0x49b2,0x4(%esp)
     8ff:	00 
     900:	89 04 24             	mov    %eax,(%esp)
     903:	e8 aa 38 00 00       	call   41b2 <printf>
    exit();
     908:	e8 dd 36 00 00       	call   3fea <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90d:	a1 e0 64 00 00       	mov    0x64e0,%eax
     912:	c7 44 24 04 c6 49 00 	movl   $0x49c6,0x4(%esp)
     919:	00 
     91a:	89 04 24             	mov    %eax,(%esp)
     91d:	e8 90 38 00 00       	call   41b2 <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     92f:	c7 44 24 04 d5 49 00 	movl   $0x49d5,0x4(%esp)
     936:	00 
     937:	89 04 24             	mov    %eax,(%esp)
     93a:	e8 73 38 00 00       	call   41b2 <printf>
  if(exec("echo", echoargv) < 0){
     93f:	c7 44 24 04 cc 64 00 	movl   $0x64cc,0x4(%esp)
     946:	00 
     947:	c7 04 24 80 45 00 00 	movl   $0x4580,(%esp)
    ...
    printf(stdout, "exec echo failed\n");
     ...
     95c:	c7 44 24 04 e0 49 00 	movl   $0x49e0,0x4(%esp)
     963:	00 
     964:	89 04 24             	mov    %eax,(%esp)
     967:	e8 46 38 00 00       	call   41b2 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     988:	c7 44 24 04 f2 49 00 	movl   $0x49f2,0x4(%esp)
     98f:	00 
     990:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     997:	e8 16 38 00 00       	call   41b2 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a1a:	c7 44 24 04 01 4a 00 	movl   $0x4a01,0x4(%esp)
     a21:	00 
     a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a29:	e8 84 37 00 00       	call   41b2 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a90:	c7 44 24 04 0f 4a 00 	movl   $0x4a0f,0x4(%esp)
     a97:	00 
     a98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9f:	e8 0e 37 00 00       	call   41b2 <printf>
    ...
    if(total != 5 * 1033){
     ...
     b06:	c7 44 24 04 1d 4a 00 	movl   $0x4a1d,0x4(%esp)
     b0d:	00 
     b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b15:	e8 98 36 00 00       	call   41b2 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2f:	c7 44 24 04 43 4a 00 	movl   $0x4a43,0x4(%esp)
     b36:	00 
     b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3e:	e8 6f 36 00 00       	call   41b2 <printf>
    ...
    printf(1, "fork() failed\n");
     b45:	c7 44 24 04 34 4a 00 	movl   $0x4a34,0x4(%esp)
     b4c:	00 
     b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b54:	e8 59 36 00 00       	call   41b2 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b66:	c7 44 24 04 4d 4a 00 	movl   $0x4a4d,0x4(%esp)
     b6d:	00 
     b6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b75:	e8 38 36 00 00       	call   41b2 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc8:	00 
     bc9:	c7 44 24 04 57 4a 00 	movl   $0x4a57,0x4(%esp)
     bd0:	00 
     ...
     bde:	c7 44 24 04 59 4a 00 	movl   $0x4a59,0x4(%esp)
     be5:	00 
     be6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bed:	e8 c0 35 00 00       	call   41b2 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     c2a:	c7 44 24 04 6d 4a 00 	movl   $0x4a6d,0x4(%esp)
     c31:	00 
     c32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c39:	e8 74 35 00 00       	call   41b2 <printf>
  ...
  printf(1, "kill... ");
     c4b:	c7 44 24 04 80 4a 00 	movl   $0x4a80,0x4(%esp)
     c52:	00 
     c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c5a:	e8 53 35 00 00       	call   41b2 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c80:	c7 44 24 04 89 4a 00 	movl   $0x4a89,0x4(%esp)
     c87:	00 
     c88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8f:	e8 1e 35 00 00       	call   41b2 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ca3:	c7 44 24 04 92 4a 00 	movl   $0x4a92,0x4(%esp)
     caa:	00 
     cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb2:	e8 fb 34 00 00       	call   41b2 <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd4:	79 16                	jns    cec <exitwait+0x33>
      printf(1, "fork failed\n");
     cd6:	c7 44 24 04 21 46 00 	movl   $0x4621,0x4(%esp)
     cdd:	00 
     cde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce5:	e8 c8 34 00 00       	call   41b2 <printf>
      return;
    ...
    if(pid){
     ...
     cfc:	c7 44 24 04 9e 4a 00 	movl   $0x4a9e,0x4(%esp)
     d03:	00 
     d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0b:	e8 a2 34 00 00       	call   41b2 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d21:	c7 44 24 04 ae 4a 00 	movl   $0x4aae,0x4(%esp)
     d28:	00 
     d29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d30:	e8 7d 34 00 00       	call   41b2 <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3d:	c7 44 24 04 bb 4a 00 	movl   $0x4abb,0x4(%esp)
     d44:	00 
     d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4c:	e8 61 34 00 00       	call   41b2 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 10 37 00 00       	call   449e <malloc>
    ...
    while(m1){
     ...
     da7:	e8 b9 35 00 00       	call   4365 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df7:	e8 69 35 00 00       	call   4365 <free>
    printf(1, "mem ok\n");
     dfc:	c7 44 24 04 df 4a 00 	movl   $0x4adf,0x4(%esp)
     e03:	00 
     e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0b:	e8 a2 33 00 00       	call   41b2 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e22:	c7 44 24 04 e7 4a 00 	movl   $0x4ae7,0x4(%esp)
     e29:	00 
     e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e31:	e8 7c 33 00 00       	call   41b2 <printf>

  unlink("sharedfd");
     e36:	c7 04 24 f6 4a 00 00 	movl   $0x4af6,(%esp)
     e3d:	e8 f8 31 00 00       	call   403a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e42:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e49:	00 
     e4a:	c7 04 24 f6 4a 00 00 	movl   $0x4af6,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5f:	c7 44 24 04 00 4b 00 	movl   $0x4b00,0x4(%esp)
     e66:	00 
     e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6e:	e8 3f 33 00 00       	call   41b2 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed1:	c7 44 24 04 2c 4b 00 	movl   $0x4b2c,0x4(%esp)
     ed8:	00 
     ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ee0:	e8 cd 32 00 00       	call   41b2 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f16:	00 
     f17:	c7 04 24 f6 4a 00 00 	movl   $0x4af6,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2c:	c7 44 24 04 4c 4b 00 	movl   $0x4b4c,0x4(%esp)
     f33:	00 
     f34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3b:	e8 72 32 00 00       	call   41b2 <printf>
    return;
  ...
  unlink("sharedfd");
     fbd:	c7 04 24 f6 4a 00 00 	movl   $0x4af6,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fdb:	c7 44 24 04 77 4b 00 	movl   $0x4b77,0x4(%esp)
     fe2:	00 
     fe3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fea:	e8 c3 31 00 00       	call   41b2 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     fff:	c7 44 24 04 84 4b 00 	movl   $0x4b84,0x4(%esp)
    1006:	00 
    1007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100e:	e8 9f 31 00 00       	call   41b2 <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 c8 99 4b 00 00 	movl   $0x4b99,-0x38(%ebp)
    1027:	c7 45 cc 9c 4b 00 00 	movl   $0x4b9c,-0x34(%ebp)
    102e:	c7 45 d0 9f 4b 00 00 	movl   $0x4b9f,-0x30(%ebp)
    1035:	c7 45 d4 a2 4b 00 00 	movl   $0x4ba2,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    103c:	c7 44 24 04 a5 4b 00 	movl   $0x4ba5,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 62 31 00 00       	call   41b2 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    107d:	79 19                	jns    1098 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107f:	c7 44 24 04 21 46 00 	movl   $0x4621,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 1f 31 00 00       	call   41b2 <printf>
      exit();
    ...
    10be:	c7 44 24 04 b5 4b 00 	movl   $0x4bb5,0x4(%esp)
    10c5:	00 
    10c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10cd:	e8 e0 30 00 00       	call   41b2 <printf>
        exit();
    ...
    112c:	c7 44 24 04 c4 4b 00 	movl   $0x4bc4,0x4(%esp)
    1133:	00 
    1134:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113b:	e8 72 30 00 00       	call   41b2 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11ce:	74 19                	je     11e9 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11d0:	c7 44 24 04 d5 4b 00 	movl   $0x4bd5,0x4(%esp)
    11d7:	00 
    11d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11df:	e8 ce 2f 00 00       	call   41b2 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    123a:	c7 44 24 04 e1 4b 00 	movl   $0x4be1,0x4(%esp)
    1241:	00 
    1242:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1249:	e8 64 2f 00 00       	call   41b2 <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    126c:	c7 44 24 04 f2 4b 00 	movl   $0x4bf2,0x4(%esp)
    1273:	00 
    1274:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127b:	e8 32 2f 00 00       	call   41b2 <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1288:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    128f:	00 
    1290:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1297:	e8 16 2f 00 00       	call   41b2 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12b4:	79 19                	jns    12cf <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b6:	c7 44 24 04 21 46 00 	movl   $0x4621,0x4(%esp)
    12bd:	00 
    12be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12c5:	e8 e8 2e 00 00       	call   41b2 <printf>
      exit();
    ...
    1315:	79 19                	jns    1330 <createdelete+0xae>
          printf(1, "create failed\n");
    1317:	c7 44 24 04 b5 4b 00 	movl   $0x4bb5,0x4(%esp)
    131e:	00 
    131f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1326:	e8 87 2e 00 00       	call   41b2 <printf>
          exit();
    ...
    136c:	c7 44 24 04 a4 46 00 	movl   $0x46a4,0x4(%esp)
    1373:	00 
    1374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    137b:	e8 32 2e 00 00       	call   41b2 <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1429:	c7 44 24 04 14 4c 00 	movl   $0x4c14,0x4(%esp)
    1430:	00 
    1431:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1438:	e8 75 2d 00 00       	call   41b2 <printf>
        exit();
    ...
    145b:	c7 44 24 04 38 4c 00 	movl   $0x4c38,0x4(%esp)
    1462:	00 
    1463:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    146a:	e8 43 2d 00 00       	call   41b2 <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14e4:	c7 44 24 04 58 4c 00 	movl   $0x4c58,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f3:	e8 ba 2c 00 00       	call   41b2 <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1500:	c7 44 24 04 69 4c 00 	movl   $0x4c69,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 9e 2c 00 00       	call   41b2 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1514:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    151b:	00 
    151c:	c7 04 24 7a 4c 00 00 	movl   $0x4c7a,(%esp)
  ...
  if(fd < 0){
    ...
    1531:	c7 44 24 04 85 4c 00 	movl   $0x4c85,0x4(%esp)
    1538:	00 
    1539:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1540:	e8 6d 2c 00 00       	call   41b2 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1551:	00 
    1552:	c7 44 24 04 9f 4c 00 	movl   $0x4c9f,0x4(%esp)
    1559:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1577:	00 
    1578:	c7 04 24 7a 4c 00 00 	movl   $0x4c7a,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    162c:	c7 44 24 04 db 4c 00 	movl   $0x4cdb,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 72 2b 00 00       	call   41b2 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    1650:	c7 44 24 04 f2 4c 00 	movl   $0x4cf2,0x4(%esp)
    1657:	00 
    1658:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165f:	e8 4e 2b 00 00       	call   41b2 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1689:	c7 44 24 04 09 4d 00 	movl   $0x4d09,0x4(%esp)
    1690:	00 
    1691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1698:	e8 15 2b 00 00       	call   41b2 <printf>
    exit();
  ...
  unlink("unlinkread");
    16ad:	c7 04 24 7a 4c 00 00 	movl   $0x4c7a,(%esp)
    16b4:	e8 81 29 00 00       	call   403a <unlink>
  printf(1, "unlinkread ok\n");
    16b9:	c7 44 24 04 22 4d 00 	movl   $0x4d22,0x4(%esp)
    16c0:	00 
    16c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c8:	e8 e5 2a 00 00       	call   41b2 <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d5:	c7 44 24 04 31 4d 00 	movl   $0x4d31,0x4(%esp)
    16dc:	00 
    16dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e4:	e8 c9 2a 00 00       	call   41b2 <printf>

  unlink("lf1");
    16e9:	c7 04 24 3b 4d 00 00 	movl   $0x4d3b,(%esp)
    16f0:	e8 45 29 00 00       	call   403a <unlink>
  unlink("lf2");
    16f5:	c7 04 24 3f 4d 00 00 	movl   $0x4d3f,(%esp)
    16fc:	e8 39 29 00 00       	call   403a <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1701:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1708:	00 
    1709:	c7 04 24 3b 4d 00 00 	movl   $0x4d3b,(%esp)
  ...
  if(fd < 0){
    ...
    171e:	c7 44 24 04 43 4d 00 	movl   $0x4d43,0x4(%esp)
    1725:	00 
    1726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172d:	e8 80 2a 00 00       	call   41b2 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    173e:	00 
    173f:	c7 44 24 04 9f 4c 00 	movl   $0x4c9f,0x4(%esp)
    1746:	00 
    ...
    1757:	c7 44 24 04 56 4d 00 	movl   $0x4d56,0x4(%esp)
    175e:	00 
    175f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1766:	e8 47 2a 00 00       	call   41b2 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17f0:	00 
    17f1:	c7 04 24 3f 4d 00 00 	movl   $0x4d3f,(%esp)
  ...
  if(fd < 0){
    ...
    1806:	c7 44 24 04 a5 4d 00 	movl   $0x4da5,0x4(%esp)
    180d:	00 
    180e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1815:	e8 98 29 00 00       	call   41b2 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    183f:	c7 44 24 04 b6 4d 00 	movl   $0x4db6,0x4(%esp)
    1846:	00 
    1847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184e:	e8 5f 29 00 00       	call   41b2 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1863:	c7 44 24 04 3f 4d 00 	movl   $0x4d3f,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 3f 4d 00 00 	movl   $0x4d3f,(%esp)
    1872:	e8 d3 27 00 00       	call   404a <link>
    1877:	85 c0                	test   %eax,%eax
    1879:	78 19                	js     1894 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    187b:	c7 44 24 04 c7 4d 00 	movl   $0x4dc7,0x4(%esp)
    1882:	00 
    1883:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188a:	e8 23 29 00 00       	call   41b2 <printf>
    exit();
    188f:	e8 56 27 00 00       	call   3fea <exit>
  }

  unlink("lf2");
    1894:	c7 04 24 3f 4d 00 00 	movl   $0x4d3f,(%esp)
    189b:	e8 9a 27 00 00       	call   403a <unlink>
  if(link("lf2", "lf1") >= 0){
    18a0:	c7 44 24 04 3b 4d 00 	movl   $0x4d3b,0x4(%esp)
    18a7:	00 
    18a8:	c7 04 24 3f 4d 00 00 	movl   $0x4d3f,(%esp)
    18af:	e8 96 27 00 00       	call   404a <link>
    18b4:	85 c0                	test   %eax,%eax
    18b6:	78 19                	js     18d1 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b8:	c7 44 24 04 e8 4d 00 	movl   $0x4de8,0x4(%esp)
    18bf:	00 
    18c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c7:	e8 e6 28 00 00       	call   41b2 <printf>
    exit();
    18cc:	e8 19 27 00 00       	call   3fea <exit>
  }

  if(link(".", "lf1") >= 0){
    18d1:	c7 44 24 04 3b 4d 00 	movl   $0x4d3b,0x4(%esp)
    18d8:	00 
    18d9:	c7 04 24 0b 4e 00 00 	movl   $0x4e0b,(%esp)
    18e0:	e8 65 27 00 00       	call   404a <link>
    18e5:	85 c0                	test   %eax,%eax
    18e7:	78 19                	js     1902 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e9:	c7 44 24 04 0d 4e 00 	movl   $0x4e0d,0x4(%esp)
    18f0:	00 
    18f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f8:	e8 b5 28 00 00       	call   41b2 <printf>
    exit();
    18fd:	e8 e8 26 00 00       	call   3fea <exit>
  }

  printf(1, "linktest ok\n");
    1902:	c7 44 24 04 29 4e 00 	movl   $0x4e29,0x4(%esp)
    1909:	00 
    190a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1911:	e8 9c 28 00 00       	call   41b2 <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    191e:	c7 44 24 04 36 4e 00 	movl   $0x4e36,0x4(%esp)
    1925:	00 
    1926:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    192d:	e8 80 28 00 00       	call   41b2 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1991:	c7 04 24 46 4e 00 00 	movl   $0x4e46,(%esp)
    ...
    19d4:	c7 04 24 46 4e 00 00 	movl   $0x4e46,(%esp)
    ...
    1a05:	c7 44 24 04 49 4e 00 	movl   $0x4e49,0x4(%esp)
    1a0c:	00 
    1a0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a14:	e8 99 27 00 00       	call   41b2 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a69:	00 
    1a6a:	c7 04 24 0b 4e 00 00 	movl   $0x4e0b,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acc:	c7 44 24 04 65 4e 00 	movl   $0x4e65,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1adb:	e8 d2 26 00 00       	call   41b2 <printf>
        exit();
    ...
    1afe:	c7 44 24 04 7e 4e 00 	movl   $0x4e7e,0x4(%esp)
    1b05:	00 
    1b06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b0d:	e8 a0 26 00 00       	call   41b2 <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b59:	c7 44 24 04 9c 4e 00 	movl   $0x4e9c,0x4(%esp)
    1b60:	00 
    1b61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b68:	e8 45 26 00 00       	call   41b2 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b93:	79 19                	jns    1bae <concreate+0x296>
      printf(1, "fork failed\n");
    1b95:	c7 44 24 04 21 46 00 	movl   $0x4621,0x4(%esp)
    1b9c:	00 
    1b9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba4:	e8 09 26 00 00       	call   41b2 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1cb5:	c7 44 24 04 cd 4e 00 	movl   $0x4ecd,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 e9 24 00 00       	call   41b2 <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cd1:	c7 44 24 04 db 4e 00 	movl   $0x4edb,0x4(%esp)
    1cd8:	00 
    1cd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce0:	e8 cd 24 00 00       	call   41b2 <printf>

  unlink("x");
    1ce5:	c7 04 24 57 4a 00 00 	movl   $0x4a57,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cff:	c7 44 24 04 21 46 00 	movl   $0x4621,0x4(%esp)
    1d06:	00 
    1d07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d0e:	e8 9f 24 00 00       	call   41b2 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d6d:	00 
    1d6e:	c7 04 24 57 4a 00 00 	movl   $0x4a57,(%esp)
    ...
    1d9f:	75 16                	jne    1db7 <linkunlink+0xec>
      link("cat", "x");
    1da1:	c7 44 24 04 57 4a 00 	movl   $0x4a57,0x4(%esp)
    1da8:	00 
    1da9:	c7 04 24 ec 4e 00 00 	movl   $0x4eec,(%esp)
    1db0:	e8 95 22 00 00       	call   404a <link>
    1db5:	eb 0c                	jmp    1dc3 <linkunlink+0xf8>
    } else {
      unlink("x");
    1db7:	c7 04 24 57 4a 00 00 	movl   $0x4a57,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1de3:	c7 44 24 04 f0 4e 00 	movl   $0x4ef0,0x4(%esp)
    1dea:	00 
    1deb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1df2:	e8 bb 23 00 00       	call   41b2 <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dff:	c7 44 24 04 ff 4e 00 	movl   $0x4eff,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 9f 23 00 00       	call   41b2 <printf>
  unlink("bd");
    1e13:	c7 04 24 0c 4f 00 00 	movl   $0x4f0c,(%esp)
    1e1a:	e8 1b 22 00 00       	call   403a <unlink>

  fd = open("bd", O_CREATE);
    1e1f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e26:	00 
    1e27:	c7 04 24 0c 4f 00 00 	movl   $0x4f0c,(%esp)
  ...
  if(fd < 0){
    ...
    1e3c:	c7 44 24 04 0f 4f 00 	movl   $0x4f0f,0x4(%esp)
    1e43:	00 
    1e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4b:	e8 62 23 00 00       	call   41b2 <printf>
    exit();
  ...
  unlink("bd");
    1ed6:	c7 04 24 0c 4f 00 00 	movl   $0x4f0c,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f2a:	c7 44 24 04 39 4f 00 	movl   $0x4f39,0x4(%esp)
    1f31:	00 
    1f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f39:	e8 74 22 00 00       	call   41b2 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f50:	c7 44 24 04 4e 4f 00 	movl   $0x4f4e,0x4(%esp)
    1f57:	00 
    1f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5f:	e8 4e 22 00 00       	call   41b2 <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6c:	c7 44 24 04 59 4f 00 	movl   $0x4f59,0x4(%esp)
    1f73:	00 
    1f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7b:	e8 32 22 00 00       	call   41b2 <printf>

  unlink("ff");
    1f80:	c7 04 24 66 4f 00 00 	movl   $0x4f66,(%esp)
    1f87:	e8 ae 20 00 00       	call   403a <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 69 4f 00 00 	movl   $0x4f69,(%esp)
    1f93:	e8 ba 20 00 00       	call   4052 <mkdir>
    1f98:	85 c0                	test   %eax,%eax
    1f9a:	74 19                	je     1fb5 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9c:	c7 44 24 04 6c 4f 00 	movl   $0x4f6c,0x4(%esp)
    1fa3:	00 
    1fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fab:	e8 02 22 00 00       	call   41b2 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbc:	00 
    1fbd:	c7 04 24 84 4f 00 00 	movl   $0x4f84,(%esp)
  ...
  if(fd < 0){
    ...
    1fd2:	c7 44 24 04 8a 4f 00 	movl   $0x4f8a,0x4(%esp)
    1fd9:	00 
    1fda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe1:	e8 cc 21 00 00       	call   41b2 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1ff2:	00 
    1ff3:	c7 44 24 04 66 4f 00 	movl   $0x4f66,0x4(%esp)
    1ffa:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    206a:	00 
    206b:	c7 04 24 e8 4f 00 00 	movl   $0x4fe8,(%esp)
  ...
  if(fd < 0){
    ...
    2080:	c7 44 24 04 f1 4f 00 	movl   $0x4ff1,0x4(%esp)
    2087:	00 
    2088:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208f:	e8 1e 21 00 00       	call   41b2 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    20a0:	00 
    20a1:	c7 44 24 04 09 50 00 	movl   $0x5009,0x4(%esp)
    20a8:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c6:	00 
    20c7:	c7 04 24 0c 50 00 00 	movl   $0x500c,(%esp)
  ...
  if(fd < 0){
    ...
    20dc:	c7 44 24 04 18 50 00 	movl   $0x5018,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 c2 20 00 00       	call   41b2 <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2124:	c7 44 24 04 31 50 00 	movl   $0x5031,0x4(%esp)
    212b:	00 
    212c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2133:	e8 7a 20 00 00       	call   41b2 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227e:	00 
    227f:	c7 04 24 4c 50 00 00 	movl   $0x504c,(%esp)
  ...
  if(fd < 0){
    ...
    2294:	c7 44 24 04 16 51 00 	movl   $0x5116,0x4(%esp)
    229b:	00 
    229c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a3:	e8 0a 1f 00 00       	call   41b2 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22cd:	c7 44 24 04 2e 51 00 	movl   $0x512e,0x4(%esp)
    22d4:	00 
    22d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22dc:	e8 d1 1e 00 00       	call   41b2 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b2:	c7 44 24 04 a8 53 00 	movl   $0x53a8,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 ec 1a 00 00       	call   41b2 <printf>

  unlink("bigwrite");
    26c6:	c7 04 24 b7 53 00 00 	movl   $0x53b7,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e5:	00 
    26e6:	c7 04 24 b7 53 00 00 	movl   $0x53b7,(%esp)
    ...
    26fb:	c7 44 24 04 c0 53 00 	movl   $0x53c0,0x4(%esp)
    2702:	00 
    2703:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270a:	e8 a3 1a 00 00       	call   41b2 <printf>
      exit();
    ...
    2750:	c7 44 24 04 d8 53 00 	movl   $0x53d8,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 4e 1a 00 00       	call   41b2 <printf>
        exit();
    ...
    unlink("bigwrite");
    277e:	c7 04 24 b7 53 00 00 	movl   $0x53b7,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279e:	c7 44 24 04 ea 53 00 	movl   $0x53ea,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 00 1a 00 00       	call   41b2 <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27ba:	c7 44 24 04 f7 53 00 	movl   $0x53f7,0x4(%esp)
    27c1:	00 
    27c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c9:	e8 e4 19 00 00       	call   41b2 <printf>

  unlink("bigfile");
    27ce:	c7 04 24 05 54 00 00 	movl   $0x5405,(%esp)
    27d5:	e8 60 18 00 00       	call   403a <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 05 54 00 00 	movl   $0x5405,(%esp)
  ...
  if(fd < 0){
    ...
    27f7:	c7 44 24 04 0d 54 00 	movl   $0x540d,0x4(%esp)
    27fe:	00 
    27ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2806:	e8 a7 19 00 00       	call   41b2 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2856:	c7 44 24 04 23 54 00 	movl   $0x5423,0x4(%esp)
    285d:	00 
    285e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2865:	e8 48 19 00 00       	call   41b2 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    288b:	00 
    288c:	c7 04 24 05 54 00 00 	movl   $0x5405,(%esp)
  ...
  if(fd < 0){
    ...
    28a1:	c7 44 24 04 39 54 00 	movl   $0x5439,0x4(%esp)
    28a8:	00 
    28a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b0:	e8 fd 18 00 00       	call   41b2 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28ec:	c7 44 24 04 4e 54 00 	movl   $0x544e,0x4(%esp)
    28f3:	00 
    28f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fb:	e8 b2 18 00 00       	call   41b2 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    292f:	c7 44 24 04 63 54 00 	movl   $0x5463,0x4(%esp)
    2936:	00 
    2937:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    293e:	e8 6f 18 00 00       	call   41b2 <printf>
      exit();
    ...
    297a:	74 19                	je     2995 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    297c:	c7 44 24 04 77 54 00 	movl   $0x5477,0x4(%esp)
    2983:	00 
    2984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    298b:	e8 22 18 00 00       	call   41b2 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    29a4:	c7 44 24 04 90 54 00 	movl   $0x5490,0x4(%esp)
    29ab:	00 
    29ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29b3:	e8 fa 17 00 00       	call   41b2 <printf>
    exit();
    29b8:	e8 2d 16 00 00       	call   3fea <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 05 54 00 00 	movl   $0x5405,(%esp)
    29c4:	e8 71 16 00 00       	call   403a <unlink>

  printf(1, "bigfile test ok\n");
    29c9:	c7 44 24 04 aa 54 00 	movl   $0x54aa,0x4(%esp)
    29d0:	00 
    29d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d8:	e8 d5 17 00 00       	call   41b2 <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a52:	00 
    2a53:	c7 04 24 48 55 00 00 	movl   $0x5548,(%esp)
  ...
  if(fd < 0){
    ...
    2a68:	c7 44 24 04 78 55 00 	movl   $0x5578,0x4(%esp)
    2a6f:	00 
    2a70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a77:	e8 36 17 00 00       	call   41b2 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a93:	00 
    2a94:	c7 04 24 b8 55 00 00 	movl   $0x55b8,(%esp)
  ...
  if(fd < 0){
    ...
    2aa9:	c7 44 24 04 e8 55 00 	movl   $0x55e8,0x4(%esp)
    2ab0:	00 
    2ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab8:	e8 f5 16 00 00       	call   41b2 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cb3:	c7 44 24 04 7f 57 00 	movl   $0x577f,0x4(%esp)
    2cba:	00 
    2cbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc2:	e8 eb 14 00 00       	call   41b2 <printf>

  fd = open("dirfile", O_CREATE);
    2cc7:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cce:	00 
    2ccf:	c7 04 24 8c 57 00 00 	movl   $0x578c,(%esp)
  ...
  if(fd < 0){
    ...
    2ce4:	c7 44 24 04 94 57 00 	movl   $0x5794,0x4(%esp)
    2ceb:	00 
    2cec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cf3:	e8 ba 14 00 00       	call   41b2 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d38:	00 
    2d39:	c7 04 24 c5 57 00 00 	movl   $0x57c5,(%esp)
  ...
  if(fd >= 0){
    ...
    2d4e:	c7 44 24 04 d0 57 00 	movl   $0x57d0,0x4(%esp)
    2d55:	00 
    2d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d5d:	e8 50 14 00 00       	call   41b2 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d6e:	00 
    2d6f:	c7 04 24 c5 57 00 00 	movl   $0x57c5,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2e50:	00 
    2e51:	c7 04 24 0b 4e 00 00 	movl   $0x4e0b,(%esp)
  ...
  if(fd >= 0){
    ...
    2e66:	c7 44 24 04 68 58 00 	movl   $0x5868,0x4(%esp)
    2e6d:	00 
    2e6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e75:	e8 38 13 00 00       	call   41b2 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eb5:	c7 44 24 04 87 58 00 	movl   $0x5887,0x4(%esp)
    2ebc:	00 
    2ebd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ec4:	e8 e9 12 00 00       	call   41b2 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2ed9:	c7 44 24 04 9b 58 00 	movl   $0x589b,0x4(%esp)
    2ee0:	00 
    2ee1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee8:	e8 c5 12 00 00       	call   41b2 <printf>
}
    2eed:	c9                   	leave  
    2eee:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ef5:	c7 44 24 04 ab 58 00 	movl   $0x58ab,0x4(%esp)
    2efc:	00 
    2efd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f04:	e8 a9 12 00 00       	call   41b2 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2fb6:	00 
    2fb7:	c7 04 24 eb 58 00 00 	movl   $0x58eb,(%esp)
    ...
    unlink("xx");
    2fd7:	c7 04 24 eb 58 00 00 	movl   $0x58eb,(%esp)
  ...
  chdir("/");
    2ff1:	c7 04 24 f2 45 00 00 	movl   $0x45f2,(%esp)
    2ff8:	e8 5d 10 00 00       	call   405a <chdir>
  printf(1, "empty file name OK\n");
    2ffd:	c7 44 24 04 ee 58 00 	movl   $0x58ee,0x4(%esp)
    3004:	00 
    3005:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    300c:	e8 a1 11 00 00       	call   41b2 <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3019:	c7 44 24 04 02 59 00 	movl   $0x5902,0x4(%esp)
    3020:	00 
    3021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3028:	e8 85 11 00 00       	call   41b2 <printf>
    ...
    304c:	e8 99 0f 00 00       	call   3fea <exit>
{
  ...
  if(n == 1000){
    ...
    3067:	c7 44 24 04 10 59 00 	movl   $0x5910,0x4(%esp)
    306e:	00 
    306f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3076:	e8 37 11 00 00       	call   41b2 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    308b:	c7 44 24 04 32 59 00 	movl   $0x5932,0x4(%esp)
    3092:	00 
    3093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    309a:	e8 13 11 00 00       	call   41b2 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30b8:	c7 44 24 04 46 59 00 	movl   $0x5946,0x4(%esp)
    30bf:	00 
    30c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30c7:	e8 e6 10 00 00       	call   41b2 <printf>
    exit();
    30cc:	e8 19 0f 00 00       	call   3fea <exit>
  }

  printf(1, "fork test OK\n");
    30d1:	c7 44 24 04 59 59 00 	movl   $0x5959,0x4(%esp)
    30d8:	00 
    30d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e0:	e8 cd 10 00 00       	call   41b2 <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    30f6:	c7 44 24 04 67 59 00 	movl   $0x5967,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 ac 10 00 00       	call   41b2 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    315e:	c7 44 24 04 72 59 00 	movl   $0x5972,0x4(%esp)
    3165:	00 
    3166:	89 04 24             	mov    %eax,(%esp)
    3169:	e8 44 10 00 00       	call   41b2 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    31a2:	c7 44 24 04 8d 59 00 	movl   $0x598d,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 00 10 00 00       	call   41b2 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31e5:	c7 44 24 04 a4 59 00 	movl   $0x59a4,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 bd 0f 00 00       	call   41b2 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    3243:	c7 44 24 04 c0 59 00 	movl   $0x59c0,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 5f 0f 00 00       	call   41b2 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    328e:	c7 44 24 04 fe 59 00 	movl   $0x59fe,0x4(%esp)
    3295:	00 
    3296:	89 04 24             	mov    %eax,(%esp)
    3299:	e8 14 0f 00 00       	call   41b2 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32d2:	c7 44 24 04 1c 5a 00 	movl   $0x5a1c,0x4(%esp)
    32d9:	00 
    32da:	89 04 24             	mov    %eax,(%esp)
    32dd:	e8 d0 0e 00 00       	call   41b2 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3339:	c7 44 24 04 54 5a 00 	movl   $0x5a54,0x4(%esp)
    3340:	00 
    3341:	89 04 24             	mov    %eax,(%esp)
    3344:	e8 69 0e 00 00       	call   41b2 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    335d:	c7 44 24 04 7c 5a 00 	movl   $0x5a7c,0x4(%esp)
    3364:	00 
    3365:	89 04 24             	mov    %eax,(%esp)
    3368:	e8 45 0e 00 00       	call   41b2 <printf>
    exit();
  ...
  if(c != a){
    ...
    33ba:	c7 44 24 04 ac 5a 00 	movl   $0x5aac,0x4(%esp)
    33c1:	00 
    33c2:	89 04 24             	mov    %eax,(%esp)
    33c5:	e8 e8 0d 00 00       	call   41b2 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33f3:	c7 44 24 04 21 46 00 	movl   $0x4621,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 af 0d 00 00       	call   41b2 <printf>
      exit();
    ...
    3427:	c7 44 24 04 cd 5a 00 	movl   $0x5acd,0x4(%esp)
    342e:	00 
    342f:	89 04 24             	mov    %eax,(%esp)
    3432:	e8 7b 0d 00 00       	call   41b2 <printf>
      kill(ppid);
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346f:	c7 44 24 04 f2 49 00 	movl   $0x49f2,0x4(%esp)
    3476:	00 
    3477:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    347e:	e8 2f 0d 00 00       	call   41b2 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d2:	00 
    34d3:	c7 44 24 04 57 4a 00 	movl   $0x4a57,0x4(%esp)
    34da:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    3578:	c7 44 24 04 e6 5a 00 	movl   $0x5ae6,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 2a 0c 00 00       	call   41b2 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    35be:	c7 44 24 04 01 5b 00 	movl   $0x5b01,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 e4 0b 00 00       	call   41b2 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    3604:	c7 44 24 04 0f 5b 00 	movl   $0x5b0f,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 9e 0b 00 00       	call   41b2 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3671:	c7 04 24 1e 5b 00 00 	movl   $0x5b1e,(%esp)
    ...
    3687:	c7 44 24 04 29 5b 00 	movl   $0x5b29,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 1b 0b 00 00       	call   41b2 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    ...
    36b4:	c7 44 24 04 42 5b 00 	movl   $0x5b42,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 ee 0a 00 00       	call   41b2 <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    ...
    36d1:	c7 44 24 04 4f 5b 00 	movl   $0x5b4f,0x4(%esp)
    36d8:	00 
    36d9:	89 04 24             	mov    %eax,(%esp)
    36dc:	e8 d1 0a 00 00       	call   41b2 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    36fe:	c7 44 24 04 59 5b 00 	movl   $0x5b59,0x4(%esp)
    3705:	00 
    3706:	89 04 24             	mov    %eax,(%esp)
    3709:	e8 a4 0a 00 00       	call   41b2 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    ...
    3726:	c7 44 24 04 6a 5b 00 	movl   $0x5b6a,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 7c 0a 00 00       	call   41b2 <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    373e:	c7 04 24 77 5b 00 00 	movl   $0x5b77,(%esp)
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 00 65 00 00 	movl   $0x5b84,0x6500(,%eax,4)
    376f:	84 5b 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    378c:	c7 44 24 04 61 5c 00 	movl   $0x5c61,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 16 0a 00 00       	call   41b2 <printf>
    exec("echo", args);
    379c:	c7 44 24 04 00 65 00 	movl   $0x6500,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 80 45 00 00 	movl   $0x4580,(%esp)
    37ab:	e8 72 08 00 00       	call   4022 <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 e0 64 00 00       	mov    0x64e0,%eax
    37b5:	c7 44 24 04 6e 5c 00 	movl   $0x5c6e,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 ed 09 00 00       	call   41b2 <printf>
    fd = open("bigarg-ok", O_CREATE);
    37c5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37cc:	00 
    37cd:	c7 04 24 77 5b 00 00 	movl   $0x5b77,(%esp)
    ...
    37f7:	c7 44 24 04 7e 5c 00 	movl   $0x5c7e,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 ab 09 00 00       	call   41b2 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3818:	00 
    3819:	c7 04 24 77 5b 00 00 	movl   $0x5b77,(%esp)
  ...
  if(fd < 0){
    ...
    3833:	c7 44 24 04 97 5c 00 	movl   $0x5c97,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 6f 09 00 00       	call   41b2 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    3853:	c7 04 24 77 5b 00 00 	movl   $0x5b77,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    386f:	c7 44 24 04 ac 5c 00 	movl   $0x5cac,0x4(%esp)
    3876:	00 
    3877:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    387e:	e8 2f 09 00 00       	call   41b2 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3959:	c7 44 24 04 b9 5c 00 	movl   $0x5cb9,0x4(%esp)
    3960:	00 
    3961:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3968:	e8 45 08 00 00       	call   41b2 <printf>
    ...
    3990:	c7 44 24 04 c5 5c 00 	movl   $0x5cc5,0x4(%esp)
    3997:	00 
    3998:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399f:	e8 0e 08 00 00       	call   41b2 <printf>
      break;
    ...
    39dc:	c7 44 24 04 d5 5c 00 	movl   $0x5cd5,0x4(%esp)
    39e3:	00 
    39e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39eb:	e8 c2 07 00 00       	call   41b2 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3b00:	c7 44 24 04 e5 5c 00 	movl   $0x5ce5,0x4(%esp)
    3b07:	00 
    3b08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b0f:	e8 9e 06 00 00       	call   41b2 <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3b2a:	c7 44 24 04 fb 5c 00 	movl   $0x5cfb,0x4(%esp)
    3b31:	00 
    3b32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b39:	e8 74 06 00 00       	call   41b2 <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    3b6f:	c7 44 24 04 08 5d 00 	movl   $0x5d08,0x4(%esp)
    3b76:	00 
    3b77:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b7e:	e8 2f 06 00 00       	call   41b2 <printf>
    exit();
    ...
    printf (1, "fork failed\n");
    3b8e:	c7 44 24 04 21 46 00 	movl   $0x4621,0x4(%esp)
    3b95:	00 
    3b96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b9d:	e8 10 06 00 00       	call   41b2 <printf>
    exit();
  ...
  printf(1, "uio test done\n");
    3bac:	c7 44 24 04 29 5d 00 	movl   $0x5d29,0x4(%esp)
    3bb3:	00 
    3bb4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3bbb:	e8 f2 05 00 00       	call   41b2 <printf>
}
    3bc0:	c9                   	leave  
    3bc1:	c3                   	ret    
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3bcf:	00 
    3bd0:	c7 04 24 38 5d 00 00 	movl   $0x5d38,(%esp)
  ...
  if (fd < 0) {
    ...
    3be5:	c7 44 24 04 3d 5d 00 	movl   $0x5d3d,0x4(%esp)
    3bec:	00 
    3bed:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3bf4:	e8 b9 05 00 00       	call   41b2 <printf>
    exit();
  ...
  printf(1, "arg test passed\n");
    3c2f:	c7 44 24 04 4a 5d 00 	movl   $0x5d4a,0x4(%esp)
    3c36:	00 
    3c37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c3e:	e8 6f 05 00 00       	call   41b2 <printf>
}
    3c43:	c9                   	leave  
    3c44:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3cb9:	00 
    3cba:	c7 04 24 6f 5d 00 00 	movl   $0x5d6f,(%esp)
...
000040ca <gettid>:
SYSCALL(gettid)
    40ca:	b8 1e 00 00 00       	mov    $0x1e,%eax
    40cf:	cd 40                	int    $0x40
    40d1:	c3                   	ret    
...
{
    40d2:	55                   	push   %ebp
    40d3:	89 e5                	mov    %esp,%ebp
    40d5:	83 ec 18             	sub    $0x18,%esp
    40d8:	8b 45 0c             	mov    0xc(%ebp),%eax
    40db:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    40de:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    40e5:	00 
    40e6:	8d 45 f4             	lea    -0xc(%ebp),%eax
    40e9:	89 44 24 04          	mov    %eax,0x4(%esp)
    40ed:	8b 45 08             	mov    0x8(%ebp),%eax
    40f0:	89 04 24             	mov    %eax,(%esp)
    40f3:	e8 12 ff ff ff       	call   400a <write>
}
    40f8:	c9                   	leave  
    40f9:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    4109:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    410d:	74 17                	je     4126 <printint+0x2c>
    410f:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    4113:	79 11                	jns    4126 <printint+0x2c>
    neg = 1;
    4115:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    411c:	8b 45 0c             	mov    0xc(%ebp),%eax
    411f:	f7 d8                	neg    %eax
    4121:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4124:	eb 06                	jmp    412c <printint+0x32>
  } else {
    x = xx;
    4126:	8b 45 0c             	mov    0xc(%ebp),%eax
    4129:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    412c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    4133:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    4136:	8d 41 01             	lea    0x1(%ecx),%eax
    4139:	89 45 f4             	mov    %eax,-0xc(%ebp)
    413c:	8b 5d 10             	mov    0x10(%ebp),%ebx
    413f:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4142:	ba 00 00 00 00       	mov    $0x0,%edx
    4147:	f7 f3                	div    %ebx
    4149:	89 d0                	mov    %edx,%eax
    414b:	0f b6 80 e8 64 00 00 	movzbl 0x64e8(%eax),%eax
    4152:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    4156:	8b 75 10             	mov    0x10(%ebp),%esi
    4159:	8b 45 ec             	mov    -0x14(%ebp),%eax
    415c:	ba 00 00 00 00       	mov    $0x0,%edx
    4161:	f7 f6                	div    %esi
    4163:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4166:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    416a:	75 c7                	jne    4133 <printint+0x39>
  if(neg)
    416c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4170:	74 10                	je     4182 <printint+0x88>
    buf[i++] = '-';
    4172:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4175:	8d 50 01             	lea    0x1(%eax),%edx
    4178:	89 55 f4             	mov    %edx,-0xc(%ebp)
    417b:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    4180:	eb 1f                	jmp    41a1 <printint+0xa7>
    4182:	eb 1d                	jmp    41a1 <printint+0xa7>
    putc(fd, buf[i]);
    4184:	8d 55 dc             	lea    -0x24(%ebp),%edx
    4187:	8b 45 f4             	mov    -0xc(%ebp),%eax
    418a:	01 d0                	add    %edx,%eax
    418c:	0f b6 00             	movzbl (%eax),%eax
    418f:	0f be c0             	movsbl %al,%eax
    4192:	89 44 24 04          	mov    %eax,0x4(%esp)
    4196:	8b 45 08             	mov    0x8(%ebp),%eax
    4199:	89 04 24             	mov    %eax,(%esp)
    419c:	e8 31 ff ff ff       	call   40d2 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    41a1:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    41a5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    41a9:	79 d9                	jns    4184 <printint+0x8a>
    putc(fd, buf[i]);
}
    41ab:	83 c4 30             	add    $0x30,%esp
    41ae:	5b                   	pop    %ebx
    41af:	5e                   	pop    %esi
    41b0:	5d                   	pop    %ebp
    41b1:	c3                   	ret    
...
{
    41b2:	55                   	push   %ebp
    41b3:	89 e5                	mov    %esp,%ebp
    41b5:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    41b8:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    41bf:	8d 45 0c             	lea    0xc(%ebp),%eax
    41c2:	83 c0 04             	add    $0x4,%eax
    41c5:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    41c8:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    41cf:	e9 7c 01 00 00       	jmp    4350 <printf+0x19e>
    c = fmt[i] & 0xff;
    41d4:	8b 55 0c             	mov    0xc(%ebp),%edx
    41d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
    41da:	01 d0                	add    %edx,%eax
    41dc:	0f b6 00             	movzbl (%eax),%eax
    41df:	0f be c0             	movsbl %al,%eax
    41e2:	25 ff 00 00 00       	and    $0xff,%eax
    41e7:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    41ea:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    41ee:	75 2c                	jne    421c <printf+0x6a>
      if(c == '%'){
    41f0:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    41f4:	75 0c                	jne    4202 <printf+0x50>
        state = '%';
    41f6:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    41fd:	e9 4a 01 00 00       	jmp    434c <printf+0x19a>
      } else {
        putc(fd, c);
    4202:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4205:	0f be c0             	movsbl %al,%eax
    4208:	89 44 24 04          	mov    %eax,0x4(%esp)
    420c:	8b 45 08             	mov    0x8(%ebp),%eax
    420f:	89 04 24             	mov    %eax,(%esp)
    4212:	e8 bb fe ff ff       	call   40d2 <putc>
    4217:	e9 30 01 00 00       	jmp    434c <printf+0x19a>
      }
    } else if(state == '%'){
    421c:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    4220:	0f 85 26 01 00 00    	jne    434c <printf+0x19a>
      if(c == 'd'){
    4226:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    422a:	75 2d                	jne    4259 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    422c:	8b 45 e8             	mov    -0x18(%ebp),%eax
    422f:	8b 00                	mov    (%eax),%eax
    4231:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    4238:	00 
    4239:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    4240:	00 
    4241:	89 44 24 04          	mov    %eax,0x4(%esp)
    4245:	8b 45 08             	mov    0x8(%ebp),%eax
    4248:	89 04 24             	mov    %eax,(%esp)
    424b:	e8 aa fe ff ff       	call   40fa <printint>
        ap++;
    4250:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4254:	e9 ec 00 00 00       	jmp    4345 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    4259:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    425d:	74 06                	je     4265 <printf+0xb3>
    425f:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    4263:	75 2d                	jne    4292 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    4265:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4268:	8b 00                	mov    (%eax),%eax
    426a:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    4271:	00 
    4272:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4279:	00 
    427a:	89 44 24 04          	mov    %eax,0x4(%esp)
    427e:	8b 45 08             	mov    0x8(%ebp),%eax
    4281:	89 04 24             	mov    %eax,(%esp)
    4284:	e8 71 fe ff ff       	call   40fa <printint>
        ap++;
    4289:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    428d:	e9 b3 00 00 00       	jmp    4345 <printf+0x193>
      } else if(c == 's'){
    4292:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4296:	75 45                	jne    42dd <printf+0x12b>
        s = (char*)*ap;
    4298:	8b 45 e8             	mov    -0x18(%ebp),%eax
    429b:	8b 00                	mov    (%eax),%eax
    429d:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    42a0:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    42a4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    42a8:	75 09                	jne    42b3 <printf+0x101>
          s = "(null)";
    42aa:	c7 45 f4 aa 5d 00 00 	movl   $0x5daa,-0xc(%ebp)
        while(*s != 0){
    42b1:	eb 1e                	jmp    42d1 <printf+0x11f>
    42b3:	eb 1c                	jmp    42d1 <printf+0x11f>
          putc(fd, *s);
    42b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    42b8:	0f b6 00             	movzbl (%eax),%eax
    42bb:	0f be c0             	movsbl %al,%eax
    42be:	89 44 24 04          	mov    %eax,0x4(%esp)
    42c2:	8b 45 08             	mov    0x8(%ebp),%eax
    42c5:	89 04 24             	mov    %eax,(%esp)
    42c8:	e8 05 fe ff ff       	call   40d2 <putc>
          s++;
    42cd:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    42d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    42d4:	0f b6 00             	movzbl (%eax),%eax
    42d7:	84 c0                	test   %al,%al
    42d9:	75 da                	jne    42b5 <printf+0x103>
    42db:	eb 68                	jmp    4345 <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    42dd:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    42e1:	75 1d                	jne    4300 <printf+0x14e>
        putc(fd, *ap);
    42e3:	8b 45 e8             	mov    -0x18(%ebp),%eax
    42e6:	8b 00                	mov    (%eax),%eax
    42e8:	0f be c0             	movsbl %al,%eax
    42eb:	89 44 24 04          	mov    %eax,0x4(%esp)
    42ef:	8b 45 08             	mov    0x8(%ebp),%eax
    42f2:	89 04 24             	mov    %eax,(%esp)
    42f5:	e8 d8 fd ff ff       	call   40d2 <putc>
        ap++;
    42fa:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42fe:	eb 45                	jmp    4345 <printf+0x193>
      } else if(c == '%'){
    4300:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    4304:	75 17                	jne    431d <printf+0x16b>
        putc(fd, c);
    4306:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4309:	0f be c0             	movsbl %al,%eax
    430c:	89 44 24 04          	mov    %eax,0x4(%esp)
    4310:	8b 45 08             	mov    0x8(%ebp),%eax
    4313:	89 04 24             	mov    %eax,(%esp)
    4316:	e8 b7 fd ff ff       	call   40d2 <putc>
    431b:	eb 28                	jmp    4345 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    431d:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    4324:	00 
    4325:	8b 45 08             	mov    0x8(%ebp),%eax
    4328:	89 04 24             	mov    %eax,(%esp)
    432b:	e8 a2 fd ff ff       	call   40d2 <putc>
        putc(fd, c);
    4330:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4333:	0f be c0             	movsbl %al,%eax
    4336:	89 44 24 04          	mov    %eax,0x4(%esp)
    433a:	8b 45 08             	mov    0x8(%ebp),%eax
    433d:	89 04 24             	mov    %eax,(%esp)
    4340:	e8 8d fd ff ff       	call   40d2 <putc>
      }
      state = 0;
    4345:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    434c:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    4350:	8b 55 0c             	mov    0xc(%ebp),%edx
    4353:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4356:	01 d0                	add    %edx,%eax
    4358:	0f b6 00             	movzbl (%eax),%eax
    435b:	84 c0                	test   %al,%al
    435d:	0f 85 71 fe ff ff    	jne    41d4 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
{
    4365:	55                   	push   %ebp
    4366:	89 e5                	mov    %esp,%ebp
    4368:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    436b:	8b 45 08             	mov    0x8(%ebp),%eax
    436e:	83 e8 08             	sub    $0x8,%eax
    4371:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4374:	a1 88 65 00 00       	mov    0x6588,%eax
    4379:	89 45 fc             	mov    %eax,-0x4(%ebp)
    437c:	eb 24                	jmp    43a2 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    437e:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4381:	8b 00                	mov    (%eax),%eax
    4383:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4386:	77 12                	ja     439a <free+0x35>
    4388:	8b 45 f8             	mov    -0x8(%ebp),%eax
    438b:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    438e:	77 24                	ja     43b4 <free+0x4f>
    4390:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4393:	8b 00                	mov    (%eax),%eax
    4395:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4398:	77 1a                	ja     43b4 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    439f:	89 45 fc             	mov    %eax,-0x4(%ebp)
    43a2:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43a5:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    43a8:	76 d4                	jbe    437e <free+0x19>
    43aa:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43ad:	8b 00                	mov    (%eax),%eax
    43af:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    43b2:	76 ca                	jbe    437e <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    43b4:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43b7:	8b 40 04             	mov    0x4(%eax),%eax
    43ba:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    43c1:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43c4:	01 c2                	add    %eax,%edx
    43c6:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43c9:	8b 00                	mov    (%eax),%eax
    43cb:	39 c2                	cmp    %eax,%edx
    43cd:	75 24                	jne    43f3 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    43cf:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43d2:	8b 50 04             	mov    0x4(%eax),%edx
    43d5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43d8:	8b 00                	mov    (%eax),%eax
    43da:	8b 40 04             	mov    0x4(%eax),%eax
    43dd:	01 c2                	add    %eax,%edx
  ...
  if(p + p->s.size == bp){
    43fd:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4400:	8b 40 04             	mov    0x4(%eax),%eax
    4403:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    440a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    440d:	01 d0                	add    %edx,%eax
    440f:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4412:	75 20                	jne    4434 <free+0xcf>
    p->s.size += bp->s.size;
    4414:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4417:	8b 50 04             	mov    0x4(%eax),%edx
    441a:	8b 45 f8             	mov    -0x8(%ebp),%eax
    441d:	8b 40 04             	mov    0x4(%eax),%eax
    4420:	01 c2                	add    %eax,%edx
    4422:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4425:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    4428:	8b 45 f8             	mov    -0x8(%ebp),%eax
    442b:	8b 10                	mov    (%eax),%edx
    442d:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4430:	89 10                	mov    %edx,(%eax)
    4432:	eb 08                	jmp    443c <free+0xd7>
  } else
    p->s.ptr = bp;
    4434:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4437:	8b 55 f8             	mov    -0x8(%ebp),%edx
    443a:	89 10                	mov    %edx,(%eax)
  freep = p;
    443c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    443f:	a3 88 65 00 00       	mov    %eax,0x6588
}
    4444:	c9                   	leave  
    4445:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    4449:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    444c:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4453:	77 07                	ja     445c <morecore+0x16>
    nu = 4096;
    4455:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    445c:	8b 45 08             	mov    0x8(%ebp),%eax
    445f:	c1 e0 03             	shl    $0x3,%eax
    4462:	89 04 24             	mov    %eax,(%esp)
    4465:	e8 08 fc ff ff       	call   4072 <sbrk>
    446a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    446d:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4471:	75 07                	jne    447a <morecore+0x34>
    return 0;
    4473:	b8 00 00 00 00       	mov    $0x0,%eax
    4478:	eb 22                	jmp    449c <morecore+0x56>
  hp = (Header*)p;
    447a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    447d:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    4480:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4483:	8b 55 08             	mov    0x8(%ebp),%edx
    4486:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    4489:	8b 45 f0             	mov    -0x10(%ebp),%eax
    448c:	83 c0 08             	add    $0x8,%eax
    448f:	89 04 24             	mov    %eax,(%esp)
    4492:	e8 ce fe ff ff       	call   4365 <free>
  return freep;
    4497:	a1 88 65 00 00       	mov    0x6588,%eax
}
    449c:	c9                   	leave  
    449d:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    44a7:	83 c0 07             	add    $0x7,%eax
    44aa:	c1 e8 03             	shr    $0x3,%eax
    44ad:	83 c0 01             	add    $0x1,%eax
    44b0:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    44b3:	a1 88 65 00 00       	mov    0x6588,%eax
    44b8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    44bb:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    44bf:	75 23                	jne    44e4 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    44c1:	c7 45 f0 80 65 00 00 	movl   $0x6580,-0x10(%ebp)
    44c8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44cb:	a3 88 65 00 00       	mov    %eax,0x6588
    44d0:	a1 88 65 00 00       	mov    0x6588,%eax
    44d5:	a3 80 65 00 00       	mov    %eax,0x6580
    base.s.size = 0;
    44da:	c7 05 84 65 00 00 00 	movl   $0x0,0x6584
    44e1:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    44e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44e7:	8b 00                	mov    (%eax),%eax
    44e9:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    44ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44ef:	8b 40 04             	mov    0x4(%eax),%eax
    44f2:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    44f5:	72 4d                	jb     4544 <malloc+0xa6>
      if(p->s.size == nunits)
    44f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44fa:	8b 40 04             	mov    0x4(%eax),%eax
    44fd:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4500:	75 0c                	jne    450e <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    4502:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4505:	8b 10                	mov    (%eax),%edx
    4507:	8b 45 f0             	mov    -0x10(%ebp),%eax
    450a:	89 10                	mov    %edx,(%eax)
    450c:	eb 26                	jmp    4534 <malloc+0x96>
      else {
        p->s.size -= nunits;
    450e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4511:	8b 40 04             	mov    0x4(%eax),%eax
    4514:	2b 45 ec             	sub    -0x14(%ebp),%eax
    4517:	89 c2                	mov    %eax,%edx
    4519:	8b 45 f4             	mov    -0xc(%ebp),%eax
    451c:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    451f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4522:	8b 40 04             	mov    0x4(%eax),%eax
    4525:	c1 e0 03             	shl    $0x3,%eax
    4528:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    452b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    452e:	8b 55 ec             	mov    -0x14(%ebp),%edx
    4531:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4534:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4537:	a3 88 65 00 00       	mov    %eax,0x6588
      return (void*)(p + 1);
    453c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    453f:	83 c0 08             	add    $0x8,%eax
    4542:	eb 38                	jmp    457c <malloc+0xde>
    }
    if(p == freep)
    4544:	a1 88 65 00 00       	mov    0x6588,%eax
    4549:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    454c:	75 1b                	jne    4569 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    454e:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4551:	89 04 24             	mov    %eax,(%esp)
    4554:	e8 ed fe ff ff       	call   4446 <morecore>
    4559:	89 45 f4             	mov    %eax,-0xc(%ebp)
    455c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4560:	75 07                	jne    4569 <malloc+0xcb>
        return 0;
    4562:	b8 00 00 00 00       	mov    $0x0,%eax
    4567:	eb 13                	jmp    457c <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4569:	8b 45 f4             	mov    -0xc(%ebp),%eax
    456c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    456f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4572:	8b 00                	mov    (%eax),%eax
    4574:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    4577:	e9 70 ff ff ff       	jmp    44ec <malloc+0x4e>
}
    457c:	c9                   	leave  
    457d:	c3                   	ret    
