...
main(int argc, char *argv[])
{
  ...
  67:	c7 44 24 04 e0 08 00 	movl   $0x8e0,0x4(%esp)
  6e:	00 
  ...
  80:	c7 44 24 04 ef 08 00 	movl   $0x8ef,0x4(%esp)
  87:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48d:	0f b6 80 90 0b 00 00 	movzbl 0xb90(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5ea:	75 09                	jne    5f5 <printf+0x101>
          s = "(null)";
 5ec:	c7 45 f4 fe 08 00 00 	movl   $0x8fe,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b6:	a1 ac 0b 00 00       	mov    0xbac,%eax
...
free(void *ap)
{
 ...
 781:	a3 ac 0b 00 00       	mov    %eax,0xbac
}
 786:	c9                   	leave  
 787:	c3                   	ret    
