...
main(int argc, char *argv[])
{
  ...
  3f:	8d 83 40 0a 00 00    	lea    0xa40(%ebx),%eax
  45:	89 44 24 04          	mov    %eax,0x4(%esp)
  49:	8b 83 40 0a 00 00    	mov    0xa40(%ebx),%eax
  4f:	89 04 24             	mov    %eax,(%esp)
  52:	e8 93 02 00 00       	call   2ea <exec>
      printf(1, "exec failed!!\n");
  57:	c7 44 24 04 86 07 00 	movl   $0x786,0x4(%esp)
  5e:	00 
  ...
  70:	c7 44 24 04 95 07 00 	movl   $0x795,0x4(%esp)
  77:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b9:	0f b6 92 c9 07 00 00 	movzbl 0x7c9(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 54f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 551:	b8 c2 07 00 00       	mov    $0x7c2,%eax
