...
main(int argc, char *argv[])
{
  ...
  16:	74 38                	je     50 <main+0x50>
        ...
        for (i = 0; i < count; ++i) {
            printf(1, "Parent ");
  18:	c7 44 24 04 5f 07 00 	movl   $0x75f,0x4(%esp)
  1f:	00 
  20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  27:	e8 c4 03 00 00       	call   3f0 <printf>
            /** sys_yield(); */
        }
        printf(1, "\n");
    } else if (pid > 0) {
  ...
  2f:	75 e7                	jne    18 <main+0x18>
        ...
        printf(1, "\n");
  31:	c7 44 24 04 5d 07 00 	movl   $0x75d,0x4(%esp)
  38:	00 
  ...
  40:	e8 ab 03 00 00       	call   3f0 <printf>
    ...
    wait();
  45:	e8 50 02 00 00       	call   29a <wait>

    exit();
  4a:	e8 43 02 00 00       	call   292 <exit>
  4f:	90                   	nop
    pid = fork();
    ...
    if (pid == 0) {
        ...
        for (i = 0; i < count; ++i) {
            printf(1, "Child ");
  50:	c7 44 24 04 56 07 00 	movl   $0x756,0x4(%esp)
  57:	00 
  58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  5f:	e8 8c 03 00 00       	call   3f0 <printf>
    uint pid, i, count = 100;
    pid = fork();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 389:	0f b6 92 6e 07 00 00 	movzbl 0x76e(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 51f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 521:	b8 67 07 00 00       	mov    $0x767,%eax
...
free(void *ap)
{
 ...
 5e1:	a1 e4 09 00 00       	mov    0x9e4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 64f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 652:	a3 e4 09 00 00       	mov    %eax,0x9e4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 1d e4 09 00 00    	mov    0x9e4,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6b9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6bb:	3b 15 e4 09 00 00    	cmp    0x9e4,%edx
...
morecore(uint nu)
{
 ...
 6ed:	e8 ee fe ff ff       	call   5e0 <free>
  return freep;
 6f2:	8b 15 e4 09 00 00    	mov    0x9e4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 714:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 717:	89 15 e4 09 00 00    	mov    %edx,0x9e4
      return (void*)(p + 1);
 ...
 72c:	eb e9                	jmp    717 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 72e:	c7 05 e4 09 00 00 e8 	movl   $0x9e8,0x9e4
 735:	09 00 00 
    base.s.size = 0;
 738:	ba e8 09 00 00       	mov    $0x9e8,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 73d:	c7 05 e8 09 00 00 e8 	movl   $0x9e8,0x9e8
 744:	09 00 00 
    base.s.size = 0;
 747:	c7 05 ec 09 00 00 00 	movl   $0x0,0x9ec
 74e:	00 00 00 
